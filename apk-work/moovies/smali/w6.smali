...
# static fields
.field private static final ʻ:Ljava/lang/String; = "android"
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lw6;->ˉ:Landroid/content/Context;

    return-void
.end method

.method private ʾ(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    .locals 3
    .annotation build Landroidx/annotation/ˉˉ;
    .end annotation

    iget-object v0, p0, Lw6;->ˉ:Landroid/content/Context;
    ...
    iget-object p1, p0, Lw6;->ˉ:Landroid/content/Context;
    ...
    iget-object v1, p0, Lw6;->ˉ:Landroid/content/Context;
...
.method private ʿ(Landroid/net/Uri;)I
    .locals 4
...
.method private ˆ(Landroid/content/Context;Landroid/net/Uri;)I
    .locals 4
    .annotation build Landroidx/annotation/ᵎ;
    .end annotation
...
.method private ˈ(Landroid/content/Context;Landroid/net/Uri;)I
    .locals 3
    .annotation build Landroidx/annotation/ᵎ;
    .end annotation
    ...
    invoke-direct {p0, p1, p2}, Lw6;->ˆ(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {p0, p2}, Lw6;->ʿ(Landroid/net/Uri;)I
...
.method public bridge synthetic ʻ(Ljava/lang/Object;Lcom/bumptech/glide/load/ˋ;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lw6;->ˉ(Landroid/net/Uri;Lcom/bumptech/glide/load/ˋ;)Z
...
.method public bridge synthetic ʼ(Ljava/lang/Object;IILcom/bumptech/glide/load/ˋ;)Lj2;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lw6;->ʽ(Landroid/net/Uri;IILcom/bumptech/glide/load/ˋ;)Lj2;
...
.method public ʽ(Landroid/net/Uri;IILcom/bumptech/glide/load/ˋ;)Lj2;
    ...
    invoke-direct {p0, p1, p2}, Lw6;->ʾ(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;

    move-result-object p2

    invoke-direct {p0, p2, p1}, Lw6;->ˈ(Landroid/content/Context;Landroid/net/Uri;)I

    move-result p1

    iget-object p3, p0, Lw6;->ˉ:Landroid/content/Context;

    invoke-static {p3, p2, p1}, Ls6;->ʼ(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public ˉ(Landroid/net/Uri;Lcom/bumptech/glide/load/ˋ;)Z
    .locals 0
    .param p1    # Landroid/net/Uri;
        .annotation build Landroidx/annotation/ˉˉ;
        .end annotation
