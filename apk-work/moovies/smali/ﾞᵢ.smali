...
# instance fields
.field ʻ:Lorg/chromium/support_lib_boundary/WebViewProviderBoundaryInterface;
...
.method public constructor <init>(Lorg/chromium/support_lib_boundary/WebViewProviderBoundaryInterface;)V
    ...
    iput-object p1, p0, Lﾞᵢ;->ʻ:Lorg/chromium/support_lib_boundary/WebViewProviderBoundaryInterface;
...
# virtual methods
.method public ʻ(Ljava/lang/String;[Ljava/lang/String;)Lﾞʽ;
    .locals 1
    ...
    iget-object v0, p0, Lﾞᵢ;->ʻ:Lorg/chromium/support_lib_boundary/WebViewProviderBoundaryInterface;
    ...
    invoke-static {p1}, Lﾞʽ;->ʼ(Ljava/lang/reflect/InvocationHandler;)Lﾞʽ;
...
.method public ʼ(Ljava/lang/String;[Ljava/lang/String;Landroidx/webkit/ᵔ$ʼ;)V
    .locals 2
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/ˉˉ;
        .end annotation
    ...
    invoke-direct {v1, p3}, Lﾞˑ;-><init>(Landroidx/webkit/ᵔ$ʼ;)V
...
.method public ʽ()[Landroidx/webkit/ـ;
    ...
    new-array v1, v1, [Landroidx/webkit/ـ;
    ...
    invoke-direct {v3, v4}, Lﾞـ;-><init>(Ljava/lang/reflect/InvocationHandler;)V
...
.method public ʾ()Landroid/webkit/WebChromeClient;
    .locals 1
...
.method public ʿ()Landroid/webkit/WebViewClient;
    .locals 1
    .annotation build Landroidx/annotation/ˉˉ;
    .end annotation
...
.method public ˆ()Landroidx/webkit/ⁱ;
    .locals 1
    .annotation build Landroidx/annotation/ˈˈ;
    .end annotation
    ...
    invoke-static {v0}, Lif;->ʽ(Ljava/lang/reflect/InvocationHandler;)Lif;
...
.method public ˈ()Landroidx/webkit/ﹳ;
    .locals 1
    .annotation build Landroidx/annotation/ˈˈ;
    .end annotation
    ...
    :cond_0
    invoke-static {v0}, Lco5;->ˈ(Ljava/lang/reflect/InvocationHandler;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lﾞﹶ;

    invoke-virtual {v0}, Lﾞﹶ;->ʻ()Landroidx/webkit/ﹳ;
...
.method public ˉ(JLandroidx/webkit/ᵔ$ʻ;)V
    .locals 2
    ...
    invoke-direct {v1, p3}, Lﾞˋ;-><init>(Landroidx/webkit/ᵔ$ʻ;)V
...
.method public ˊ(Landroidx/webkit/י;Landroid/net/Uri;)V
    .locals 2
...
.method public ˎ(Ljava/util/concurrent/Executor;Landroidx/webkit/ﹳ;)V
    .locals 1
    ...
    invoke-direct {v0, p1, p2}, Lﾞﹶ;-><init>(Ljava/util/concurrent/Executor;Landroidx/webkit/ﹳ;)V
    ...
    :goto_0
    iget-object p2, p0, Lﾞᵢ;->ʻ:Lorg/chromium/support_lib_boundary/WebViewProviderBoundaryInterface;
