...
.method public ʼ(I)Landroid/view/View;
    ...
    invoke-virtual {v0, p1}, Landroidx/recyclerview/widget/RecyclerView$ـ;->ˉˉ(I)Landroid/view/View;
...
.method public ʽ()I
    ...
    invoke-virtual {v0}, Landroidx/recyclerview/widget/RecyclerView$ـ;->ᵔᵔ()I
...
.method protected ˋ(Landroid/graphics/PointF;)V
    .locals 2
...
.method ˎ(II)V
    ...
    iget-object v2, v0, Landroidx/recyclerview/widget/RecyclerView;->mState:Landroidx/recyclerview/widget/RecyclerView$ᐧᐧ;

    iget-object v3, p0, Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ;->ˈ:Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ$ʻ;

    invoke-virtual {p0, v1, v2, v3}, Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ;->ٴ(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView$ᐧᐧ;Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ$ʻ;)V

    iget-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ;->ˈ:Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ$ʻ;

    invoke-virtual {v1, v0}, Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ$ʻ;->ˈ(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    invoke-virtual {p0, p1, p2, v1, v2}, Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ;->ˑ(IILandroidx/recyclerview/widget/RecyclerView$ᐧᐧ;Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ$ʻ;)V

    iget-object p1, p0, Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ;->ˈ:Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ$ʻ;

    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ$ʻ;->ʿ()Z

    move-result p1

    iget-object p2, p0, Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ;->ˈ:Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ$ʻ;

    invoke-virtual {p2, v0}, Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ$ʻ;->ˈ(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iget-object p1, v0, Landroidx/recyclerview/widget/RecyclerView;->mViewFlinger:Landroidx/recyclerview/widget/RecyclerView$ʻʻ;
...
.method protected abstract ˑ(IILandroidx/recyclerview/widget/RecyclerView$ᐧᐧ;Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ$ʻ;)V
    .param p1    # I
    ...
    .param p3    # Landroidx/recyclerview/widget/RecyclerView$ᐧᐧ;
        ...
        .end annotation
    .end param
    .param p4    # Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ$ʻ;
        .annotation build Landroidx/annotation/ˉˉ;
        .end annotation
    .end param
.end method
...
.method protected abstract ٴ(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView$ᐧᐧ;Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ$ʻ;)V
    ...
    .param p2    # Landroidx/recyclerview/widget/RecyclerView$ᐧᐧ;
        ...
        .end annotation
    .end param
    .param p3    # Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ$ʻ;
        .annotation build Landroidx/annotation/ˉˉ;
        .end annotation
    .end param
.end method
...
.method ᴵ(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$ـ;)V
    .locals 2

    iget-object v0, p1, Landroidx/recyclerview/widget/RecyclerView;->mViewFlinger:Landroidx/recyclerview/widget/RecyclerView$ʻʻ;
    ...
    iput p2, p1, Landroidx/recyclerview/widget/RecyclerView$ᐧᐧ;->ʾ:I
    ...
    iget-object p2, p2, Landroidx/recyclerview/widget/RecyclerView;->mViewFlinger:Landroidx/recyclerview/widget/RecyclerView$ʻʻ;
...
.method protected final ᵎ()V
    ...
    invoke-virtual {p0}, Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ;->ـ()V
    ...
    iput v2, v1, Landroidx/recyclerview/widget/RecyclerView$ᐧᐧ;->ʾ:I
    ...
    invoke-virtual {v0, p0}, Landroidx/recyclerview/widget/RecyclerView$ـ;->ʾˆ(Landroidx/recyclerview/widget/RecyclerView$ﾞﾞ;)V
