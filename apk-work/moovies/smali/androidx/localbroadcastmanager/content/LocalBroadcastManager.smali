...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʼ;,
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    new-instance v0, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʻ;

    invoke-virtual {p1}, Landroid/content/Context;->getMainLooper()Landroid/os/Looper;

    move-result-object p1

    invoke-direct {v0, p0, p1}, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʻ;-><init>(Landroidx/localbroadcastmanager/content/LocalBroadcastManager;Landroid/os/Looper;)V
...
.method executePendingBroadcasts()V
    ...
    :cond_1
    new-array v2, v1, [Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʼ;
    ...
    iget-object v5, v4, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʼ;->ʼ:Ljava/util/ArrayList;
    ...
    iget-object v7, v4, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʼ;->ʼ:Ljava/util/ArrayList;

    invoke-virtual {v7, v6}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v7

    check-cast v7, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʽ;

    iget-boolean v8, v7, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʽ;->ʾ:Z

    if-nez v8, :cond_2

    iget-object v7, v7, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʽ;->ʼ:Landroid/content/BroadcastReceiver;

    iget-object v8, p0, Landroidx/localbroadcastmanager/content/LocalBroadcastManager;->mAppContext:Landroid/content/Context;

    iget-object v9, v4, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʼ;->ʻ:Landroid/content/Intent;
...
.method public registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V
    ...
    :try_start_0
    new-instance v1, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʽ;

    invoke-direct {v1, p2, p1}, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʽ;-><init>(Landroid/content/IntentFilter;Landroid/content/BroadcastReceiver;)V
...
.method public sendBroadcast(Landroid/content/Intent;)Z
    ...
    check-cast v5, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʽ;
    ...
    iget-object v9, v5, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʽ;->ʻ:Landroid/content/IntentFilter;
    ...
    :cond_3
    iget-boolean v3, v5, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʽ;->ʽ:Z
    ...
    :cond_5
    iget-object v3, v5, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʽ;->ʻ:Landroid/content/IntentFilter;
    ...
    iput-boolean v11, v15, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʽ;->ʽ:Z
    ...
    check-cast v4, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʽ;

    const/4 v5, 0x0

    iput-boolean v5, v4, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʽ;->ʽ:Z
    ...
    new-instance v4, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʼ;

    invoke-direct {v4, v0, v10}, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʼ;-><init>(Landroid/content/Intent;Ljava/util/ArrayList;)V
...
.method public unregisterReceiver(Landroid/content/BroadcastReceiver;)V
    ...
    iput-boolean v3, v4, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʽ;->ʾ:Z

    const/4 v5, 0x0

    :goto_1
    iget-object v6, v4, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʽ;->ʻ:Landroid/content/IntentFilter;
    ...
    check-cast v9, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʽ;

    iget-object v10, v9, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʽ;->ʼ:Landroid/content/BroadcastReceiver;

    if-ne v10, p1, :cond_1

    iput-boolean v3, v9, Landroidx/localbroadcastmanager/content/LocalBroadcastManager$ʽ;->ʾ:Z
