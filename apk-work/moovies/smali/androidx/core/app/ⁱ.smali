.class Landroidx/core/app/ⁱ;
.super Ljava/lang/Object;

# interfaces
.implements Landroidx/core/app/ᴵ;
...
.field private final ʽ:Landroidx/core/app/ᵢ$ˈ;
...
# direct methods
.method constructor <init>(Landroidx/core/app/ᵢ$ˈ;)V
    .locals 13
    ...
    iput-object v0, p0, Landroidx/core/app/ⁱ;->ˆ:Ljava/util/List;

    new-instance v0, Landroid/os/Bundle;

    invoke-direct {v0}, Landroid/os/Bundle;-><init>()V

    iput-object v0, p0, Landroidx/core/app/ⁱ;->ˈ:Landroid/os/Bundle;

    iput-object p1, p0, Landroidx/core/app/ⁱ;->ʽ:Landroidx/core/app/ᵢ$ˈ;

    iget-object v0, p1, Landroidx/core/app/ᵢ$ˈ;->ʼ:Landroid/content/Context;

    iput-object v0, p0, Landroidx/core/app/ⁱ;->ʻ:Landroid/content/Context;
    ...
    iget-object v3, p1, Landroidx/core/app/ᵢ$ˈ;->ʼ:Landroid/content/Context;

    iget-object v4, p1, Landroidx/core/app/ᵢ$ˈ;->ˊˊ:Ljava/lang/String;

    invoke-direct {v2, v3, v4}, Landroid/app/Notification$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v2, p0, Landroidx/core/app/ⁱ;->ʼ:Landroid/app/Notification$Builder;
    ...
    :goto_0
    iget-object v2, p1, Landroidx/core/app/ᵢ$ˈ;->ﹳﹳ:Landroid/app/Notification;

    iget-object v3, p0, Landroidx/core/app/ⁱ;->ʼ:Landroid/app/Notification$Builder;
    ...
    iget-object v5, p1, Landroidx/core/app/ᵢ$ˈ;->ˋ:Landroid/widget/RemoteViews;
    ...
    iget-object v4, p1, Landroidx/core/app/ᵢ$ˈ;->ˆ:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Landroidx/core/app/ᵢ$ˈ;->ˈ:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Landroidx/core/app/ᵢ$ˈ;->ˏ:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentInfo(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Landroidx/core/app/ᵢ$ˈ;->ˉ:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Landroidx/core/app/ᵢ$ˈ;->ˊ:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Landroidx/core/app/ᵢ$ˈ;->ˎ:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, Landroidx/core/app/ᵢ$ˈ;->ˑ:I

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setNumber(I)Landroid/app/Notification$Builder;

    move-result-object v3

    iget v4, p1, Landroidx/core/app/ᵢ$ˈ;->ⁱ:I

    iget v9, p1, Landroidx/core/app/ᵢ$ˈ;->ﹳ:I

    iget-boolean v10, p1, Landroidx/core/app/ᵢ$ˈ;->ﹶ:Z
    ...
    iget-object v4, p0, Landroidx/core/app/ⁱ;->ʼ:Landroid/app/Notification$Builder;
    ...
    iget-object v0, p0, Landroidx/core/app/ⁱ;->ʼ:Landroid/app/Notification$Builder;

    iget-object v8, p1, Landroidx/core/app/ᵢ$ˈ;->ᵎ:Ljava/lang/CharSequence;
    ...
    check-cast v8, Landroidx/core/app/ᵢ$ʼ;

    invoke-direct {p0, v8}, Landroidx/core/app/ⁱ;->ʼ(Landroidx/core/app/ᵢ$ʼ;)V

    goto :goto_5

    :cond_6
    iget-object v0, p1, Landroidx/core/app/ᵢ$ˈ;->ʿʿ:Landroid/os/Bundle;

    if-eqz v0, :cond_7

    iget-object v8, p0, Landroidx/core/app/ⁱ;->ˈ:Landroid/os/Bundle;
    ...
    iget-boolean v0, p1, Landroidx/core/app/ᵢ$ˈ;->ᴵᴵ:Z

    if-eqz v0, :cond_8

    iget-object v0, p0, Landroidx/core/app/ⁱ;->ˈ:Landroid/os/Bundle;
    ...
    :cond_8
    iget-object v0, p1, Landroidx/core/app/ᵢ$ˈ;->ﾞ:Ljava/lang/String;
    ...
    iget-boolean v0, p1, Landroidx/core/app/ᵢ$ˈ;->ﾞﾞ:Z
    ...
    :cond_a
    :goto_6
    iget-object v0, p1, Landroidx/core/app/ᵢ$ˈ;->ᐧᐧ:Ljava/lang/String;
    ...
    :cond_b
    iget-object v0, p1, Landroidx/core/app/ᵢ$ˈ;->ˉˉ:Landroid/widget/RemoteViews;

    iput-object v0, p0, Landroidx/core/app/ⁱ;->ʾ:Landroid/widget/RemoteViews;

    iget-object v0, p1, Landroidx/core/app/ᵢ$ˈ;->ˈˈ:Landroid/widget/RemoteViews;

    iput-object v0, p0, Landroidx/core/app/ⁱ;->ʿ:Landroid/widget/RemoteViews;
    ...
    iget-object v8, p0, Landroidx/core/app/ⁱ;->ʼ:Landroid/app/Notification$Builder;

    iget-boolean v9, p1, Landroidx/core/app/ᵢ$ˈ;->ـ:Z
    ...
    iget-object v8, p1, Landroidx/core/app/ᵢ$ˈ;->ʾ:Ljava/util/ArrayList;

    invoke-static {v8}, Landroidx/core/app/ⁱ;->ˈ(Ljava/util/List;)Ljava/util/List;

    move-result-object v8

    iget-object v9, p1, Landroidx/core/app/ᵢ$ˈ;->ʻʼ:Ljava/util/ArrayList;

    invoke-static {v8, v9}, Landroidx/core/app/ⁱ;->ʿ(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v9, p0, Landroidx/core/app/ⁱ;->ˈ:Landroid/os/Bundle;
    ...
    iget-object v0, p1, Landroidx/core/app/ᵢ$ˈ;->ʾ:Ljava/util/ArrayList;

    invoke-static {v0}, Landroidx/core/app/ⁱ;->ˈ(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iget-object v3, p1, Landroidx/core/app/ᵢ$ˈ;->ʻʼ:Ljava/util/ArrayList;

    invoke-static {v0, v3}, Landroidx/core/app/ⁱ;->ʿ(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    :cond_10
    iget-object v0, p1, Landroidx/core/app/ᵢ$ˈ;->ʻʼ:Ljava/util/ArrayList;
    ...
    :cond_11
    iget-object v0, p1, Landroidx/core/app/ᵢ$ˈ;->ˋˋ:Landroid/widget/RemoteViews;

    iput-object v0, p0, Landroidx/core/app/ⁱ;->ˊ:Landroid/widget/RemoteViews;

    iget-object v0, p1, Landroidx/core/app/ᵢ$ˈ;->ʿ:Ljava/util/ArrayList;
    ...
    :goto_9
    iget-object v11, p1, Landroidx/core/app/ᵢ$ˈ;->ʿ:Ljava/util/ArrayList;
    ...
    iget-object v12, p1, Landroidx/core/app/ᵢ$ˈ;->ʿ:Ljava/util/ArrayList;

    invoke-virtual {v12, v10}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v12

    check-cast v12, Landroidx/core/app/ᵢ$ʼ;

    invoke-static {v12}, Landroidx/core/app/ﹶ;->ˋ(Landroidx/core/app/ᵢ$ʼ;)Landroid/os/Bundle;
    ...
    iget-object v3, p1, Landroidx/core/app/ᵢ$ˈ;->ﹶﹶ:Landroid/graphics/drawable/Icon;
    ...
    iget-object v8, p1, Landroidx/core/app/ᵢ$ˈ;->ʿʿ:Landroid/os/Bundle;

    invoke-virtual {v3, v8}, Landroid/app/Notification$Builder;->setExtras(Landroid/os/Bundle;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v8, p1, Landroidx/core/app/ᵢ$ˈ;->ᵢ:[Ljava/lang/CharSequence;
    ...
    iget-object v3, p1, Landroidx/core/app/ᵢ$ˈ;->ˉˉ:Landroid/widget/RemoteViews;
    ...
    :cond_16
    iget-object v3, p1, Landroidx/core/app/ᵢ$ˈ;->ˈˈ:Landroid/widget/RemoteViews;
    ...
    :cond_17
    iget-object v3, p1, Landroidx/core/app/ᵢ$ˈ;->ˋˋ:Landroid/widget/RemoteViews;
    ...
    check-cast v4, Landroidx/core/app/ʽʽ;

    iget-object v7, p0, Landroidx/core/app/ⁱ;->ʼ:Landroid/app/Notification$Builder;

    invoke-virtual {v4}, Landroidx/core/app/ʽʽ;->ˎ()Landroid/app/Person;
    ...
    iget-boolean v7, p1, Landroidx/core/app/ᵢ$ˈ;->ᵢᵢ:Z
    ...
    iget-object v7, p1, Landroidx/core/app/ᵢ$ˈ;->ⁱⁱ:Landroidx/core/app/ᵢ$ˆ;

    invoke-static {v7}, Landroidx/core/app/ᵢ$ˆ;->ˎ(Landroidx/core/app/ᵢ$ˆ;)Landroid/app/Notification$BubbleMetadata;
    ...
    iget-object v4, p1, Landroidx/core/app/ᵢ$ˈ;->ˑˑ:Landroidx/core/content/ʼʼ;

    if-eqz v4, :cond_1c

    iget-object v7, p0, Landroidx/core/app/ⁱ;->ʼ:Landroid/app/Notification$Builder;

    invoke-virtual {v4}, Landroidx/core/content/ʼʼ;->ʽ()Landroid/content/LocusId;
    ...
    iget v4, p1, Landroidx/core/app/ᵢ$ˈ;->ᵎᵎ:I
    ...
    :cond_1d
    iget-boolean p1, p1, Landroidx/core/app/ᵢ$ˈ;->ٴٴ:Z

    if-eqz p1, :cond_20

    iget-object p1, p0, Landroidx/core/app/ⁱ;->ʽ:Landroidx/core/app/ᵢ$ˈ;

    iget-boolean p1, p1, Landroidx/core/app/ᵢ$ˈ;->ﾞﾞ:Z

    if-eqz p1, :cond_1e

    iput v5, p0, Landroidx/core/app/ⁱ;->ˉ:I

    goto :goto_b

    :cond_1e
    iput v6, p0, Landroidx/core/app/ⁱ;->ˉ:I

    :goto_b
    iget-object p1, p0, Landroidx/core/app/ⁱ;->ʼ:Landroid/app/Notification$Builder;
    ...
    iget-object v2, p0, Landroidx/core/app/ⁱ;->ʼ:Landroid/app/Notification$Builder;
    ...
    iget-object p1, p1, Landroidx/core/app/ᵢ$ˈ;->ﾞ:Ljava/lang/String;
    ...
    iget v0, p0, Landroidx/core/app/ⁱ;->ˉ:I
...
.method private ʼ(Landroidx/core/app/ᵢ$ʼ;)V
    .locals 5
    ...
    invoke-static {v1}, Landroidx/core/app/ʿʿ;->ʾ([Landroidx/core/app/ʿʿ;)[Landroid/app/RemoteInput;
    ...
    :cond_8
    invoke-virtual {p1}, Landroidx/core/app/ᵢ$ʼ;->ˊ()Z
    ...
    iget-object v0, p0, Landroidx/core/app/ⁱ;->ˆ:Ljava/util/List;

    iget-object v1, p0, Landroidx/core/app/ⁱ;->ʼ:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Landroidx/core/app/ﹶ;->ـ(Landroid/app/Notification$Builder;Landroidx/core/app/ᵢ$ʼ;)Landroid/os/Bundle;
...
.method private static ʿ(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    .locals 3
    ...
    invoke-direct {v0, v1}, Lˑˑ;-><init>(I)V

    invoke-virtual {v0, p0}, Lˑˑ;->addAll(Ljava/util/Collection;)Z

    invoke-virtual {v0, p1}, Lˑˑ;->addAll(Ljava/util/Collection;)Z
...
.method private static ˈ(Ljava/util/List;)Ljava/util/List;
    .locals 2
    .param p0    # Ljava/util/List;
        .annotation build Landroidx/annotation/ˈˈ;
        .end annotation
    ...
    invoke-virtual {v1}, Landroidx/core/app/ʽʽ;->ˋ()Ljava/lang/String;
...
.method private ˉ(Landroid/app/Notification;)V
    .locals 1
...
# virtual methods
.method public ʻ()Landroid/app/Notification$Builder;
    .locals 1
...
.method public ʽ()Landroid/app/Notification;
    .locals 5

    iget-object v0, p0, Landroidx/core/app/ⁱ;->ʽ:Landroidx/core/app/ᵢ$ˈ;

    iget-object v0, v0, Landroidx/core/app/ᵢ$ˈ;->ᴵ:Landroidx/core/app/ᵢ$ᐧ;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0}, Landroidx/core/app/ᵢ$ᐧ;->ʼ(Landroidx/core/app/ᴵ;)V

    :cond_0
    if-eqz v0, :cond_1

    invoke-virtual {v0, p0}, Landroidx/core/app/ᵢ$ᐧ;->ﹳ(Landroidx/core/app/ᴵ;)Landroid/widget/RemoteViews;
    ...
    :goto_0
    invoke-virtual {p0}, Landroidx/core/app/ⁱ;->ʾ()Landroid/app/Notification;
    ...
    :cond_2
    iget-object v1, p0, Landroidx/core/app/ⁱ;->ʽ:Landroidx/core/app/ᵢ$ˈ;

    iget-object v1, v1, Landroidx/core/app/ᵢ$ˈ;->ˉˉ:Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v0, p0}, Landroidx/core/app/ᵢ$ᐧ;->ⁱ(Landroidx/core/app/ᴵ;)Landroid/widget/RemoteViews;
    ...
    iget-object v4, p0, Landroidx/core/app/ⁱ;->ʽ:Landroidx/core/app/ᵢ$ˈ;

    iget-object v4, v4, Landroidx/core/app/ᵢ$ˈ;->ᴵ:Landroidx/core/app/ᵢ$ᐧ;

    invoke-virtual {v4, p0}, Landroidx/core/app/ᵢ$ᐧ;->ﹶ(Landroidx/core/app/ᴵ;)Landroid/widget/RemoteViews;
    ...
    invoke-static {v2}, Landroidx/core/app/ᵢ;->י(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v1

    if-eqz v1, :cond_6

    invoke-virtual {v0, v1}, Landroidx/core/app/ᵢ$ᐧ;->ʻ(Landroid/os/Bundle;)V

    :cond_6
    return-object v2
.end method

.method protected ʾ()Landroid/app/Notification;
    .locals 7
    ...
    iget v1, p0, Landroidx/core/app/ⁱ;->ˉ:I
    ...
    invoke-direct {p0, v0}, Landroidx/core/app/ⁱ;->ˉ(Landroid/app/Notification;)V
    ...
    iget-object v1, p0, Landroidx/core/app/ⁱ;->ˈ:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Landroidx/core/app/ⁱ;->ʾ:Landroid/widget/RemoteViews;
    ...
    :cond_4
    iget-object v1, p0, Landroidx/core/app/ⁱ;->ʿ:Landroid/widget/RemoteViews;
    ...
    :cond_5
    iget-object v1, p0, Landroidx/core/app/ⁱ;->ˊ:Landroid/widget/RemoteViews;
    ...
    invoke-static {v0}, Landroidx/core/app/ﹶ;->ʻ(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    invoke-static {v0}, Landroidx/core/app/ᵢ;->י(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v1

    new-instance v3, Landroid/os/Bundle;

    iget-object v4, p0, Landroidx/core/app/ⁱ;->ˈ:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Landroidx/core/app/ⁱ;->ˆ:Ljava/util/List;

    invoke-static {v1}, Landroidx/core/app/ﹶ;->ʻ(Ljava/util/List;)Landroid/util/SparseArray;
...
.method ˆ()Landroid/content/Context;
    ...
    iget-object v0, p0, Landroidx/core/app/ⁱ;->ʻ:Landroid/content/Context;
