...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroidx/core/widget/TextViewCompat$ʻ;
    }
.end annotation
...
.method public static getTextMetricsParams(Landroid/widget/TextView;)Lˊʼ$ʻ;
    .locals 4
    .param p0    # Landroid/widget/TextView;
        .annotation build Landroidx/annotation/ˉˉ;
        .end annotation
    ...
    invoke-direct {v0, p0}, Lˊʼ$ʻ;-><init>(Landroid/text/PrecomputedText$Params;)V

    return-object v0

    :cond_0
    new-instance v1, Lˊʼ$ʻ$ʻ;
    ...
    invoke-direct {v1, v2}, Lˊʼ$ʻ$ʻ;-><init>(Landroid/text/TextPaint;)V
    ...
    invoke-virtual {v1, p0}, Lˊʼ$ʻ$ʻ;->ʾ(Landroid/text/TextDirectionHeuristic;)Lˊʼ$ʻ$ʻ;

    :cond_2
    invoke-virtual {v1}, Lˊʼ$ʻ$ʻ;->ʻ()Lˊʼ$ʻ;
...
.method public static setPrecomputedText(Landroid/widget/TextView;Lˊʼ;)V
    .locals 2
    .param p0    # Landroid/widget/TextView;
        .annotation build Landroidx/annotation/ˉˉ;
        .end annotation
    ...
    invoke-virtual {p1}, Lˊʼ;->ˆ()Landroid/text/PrecomputedText;
    ...
    invoke-virtual {p1}, Lˊʼ;->ʿ()Lˊʼ$ʻ;

    move-result-object v1

    invoke-virtual {v0, v1}, Lˊʼ$ʻ;->ʻ(Lˊʼ$ʻ;)Z
...
.method public static setTextMetricsParams(Landroid/widget/TextView;Lˊʼ$ʻ;)V
    .locals 2
    .param p0    # Landroid/widget/TextView;
        .annotation build Landroidx/annotation/ˉˉ;
        .end annotation
