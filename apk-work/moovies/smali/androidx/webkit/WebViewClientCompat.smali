...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/webkit/WebViewClientCompat$ʻ;
    }
.end annotation
...
.method public final onReceivedError(Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;Landroid/webkit/WebResourceError;)V
    ...
    invoke-direct {v0, p3}, Lﾞٴ;-><init>(Landroid/webkit/WebResourceError;)V

    invoke-virtual {p0, p1, p2, v0}, Landroidx/webkit/WebViewClientCompat;->onReceivedError(Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;Landroidx/webkit/ٴ;)V

    return-void
.end method

.method public onReceivedError(Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;Landroidx/webkit/ٴ;)V
    .locals 2
    .param p1    # Landroid/webkit/WebView;
        .annotation build Landroidx/annotation/ˉˉ;
        .end annotation
    ...
    :cond_1
    invoke-static {p2}, Lﹶˎ;->ʼ(Landroid/webkit/WebResourceRequest;)Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {p3}, Landroidx/webkit/ٴ;->ʼ()I

    move-result v0

    invoke-virtual {p3}, Landroidx/webkit/ٴ;->ʻ()Ljava/lang/CharSequence;
    ...
    invoke-static {p2}, Lﹶˎ;->ʻ(Landroid/webkit/WebResourceRequest;)Landroid/net/Uri;
...
.method public final onReceivedError(Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;Ljava/lang/reflect/InvocationHandler;)V
    ...
    invoke-direct {v0, p3}, Lﾞٴ;-><init>(Ljava/lang/reflect/InvocationHandler;)V
...
.method public final onSafeBrowsingHit(Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;ILandroid/webkit/SafeBrowsingResponse;)V
    ...
    invoke-direct {v0, p4}, Lﾞʼ;-><init>(Landroid/webkit/SafeBrowsingResponse;)V

    invoke-virtual {p0, p1, p2, p3, v0}, Landroidx/webkit/WebViewClientCompat;->onSafeBrowsingHit(Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;ILandroidx/webkit/ˈ;)V

    return-void
.end method

.method public onSafeBrowsingHit(Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;ILandroidx/webkit/ˈ;)V
    .locals 0
    .param p1    # Landroid/webkit/WebView;
        .annotation build Landroidx/annotation/ˉˉ;
        .end annotation
    ...
    invoke-static {p1}, Landroidx/webkit/ᵢ;->ʻ(Ljava/lang/String;)Z
    ...
    invoke-virtual {p4, p1}, Landroidx/webkit/ˈ;->ʽ(Z)V
...
.method public final onSafeBrowsingHit(Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;ILjava/lang/reflect/InvocationHandler;)V
    ...
    invoke-direct {v0, p4}, Lﾞʼ;-><init>(Ljava/lang/reflect/InvocationHandler;)V
