.class public final Landroidx/webkit/ᵎ$ʽ;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/webkit/ᵎ$ʽ;->ʻ:[Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Ljava/io/File;)V
    ...
    invoke-static {p2}, Lﹶᵎ;->ʻ(Ljava/io/File;)Ljava/lang/String;

    move-result-object v1

    invoke-direct {v0, v1}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    iput-object v0, p0, Landroidx/webkit/ᵎ$ʽ;->ʼ:Ljava/io/File;

    invoke-direct {p0, p1}, Landroidx/webkit/ᵎ$ʽ;->ʼ(Landroid/content/Context;)Z
...
.method private ʼ(Landroid/content/Context;)Z
    .locals 7
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/ˉˉ;
        .end annotation
    ...
    iget-object v0, p0, Landroidx/webkit/ᵎ$ʽ;->ʼ:Ljava/io/File;

    invoke-static {v0}, Lﹶᵎ;->ʻ(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lﹶᵎ;->ʻ(Ljava/io/File;)Ljava/lang/String;

    move-result-object v1

    invoke-static {p1}, Lﹶᵎ;->ʽ(Landroid/content/Context;)Ljava/io/File;

    move-result-object p1

    invoke-static {p1}, Lﹶᵎ;->ʻ(Ljava/io/File;)Ljava/lang/String;
    ...
    :cond_1
    sget-object v1, Landroidx/webkit/ᵎ$ʽ;->ʻ:[Ljava/lang/String;
...
.method public ʻ(Ljava/lang/String;)Landroid/webkit/WebResourceResponse;
    ...
    :try_start_0
    iget-object v2, p0, Landroidx/webkit/ᵎ$ʽ;->ʼ:Ljava/io/File;

    invoke-static {v2, p1}, Lﹶᵎ;->ʼ(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v2

    if-eqz v2, :cond_0

    invoke-static {v2}, Lﹶᵎ;->ˊ(Ljava/io/File;)Ljava/io/InputStream;
    ...
    iget-object v5, p0, Landroidx/webkit/ᵎ$ʽ;->ʼ:Ljava/io/File;
