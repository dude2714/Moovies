...
.method constructor <init>(Lle;)V
    ...
    iput-object p1, p0, Lle$ʼ;->ʽʽ:Lle;
...
.method public bridge synthetic accept(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lle$ʼ;->ʻ(Lqo1;)V
...
.method public ʻ(Lqo1;)V
    ...
    iget-object v2, v0, Lle$ʼ;->ʽʽ:Lle;

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    invoke-static {v2, v3}, Lle;->ᐧᐧ(Lle;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v9, v0, Lle$ʼ;->ʽʽ:Lle;

    invoke-static {v9}, Lle;->ﾞﾞ(Lle;)Ljava/util/ArrayList;
    ...
    :cond_4
    iget-object v8, v0, Lle$ʼ;->ʽʽ:Lle;

    invoke-static {v8}, Lle;->ﾞﾞ(Lle;)Ljava/util/ArrayList;
    ...
    :cond_5
    iget-object v1, v0, Lle$ʼ;->ʽʽ:Lle;

    new-instance v2, Lcom/bweather/forecast/adapter/ˈ;

    iget-object v3, v0, Lle$ʼ;->ʽʽ:Lle;

    invoke-static {v3}, Lle;->ﾞﾞ(Lle;)Ljava/util/ArrayList;

    move-result-object v3

    iget-object v4, v0, Lle$ʼ;->ʽʽ:Lle;

    invoke-virtual {v4}, Lcom/bweather/forecast/base/ʻ;->ˏ()Landroid/content/Context;

    move-result-object v4

    iget-object v5, v0, Lle$ʼ;->ʽʽ:Lle;

    iget-object v5, v5, Lcom/bweather/forecast/base/ʻ;->ʼʼ:Lcom/bumptech/glide/ˑ;

    invoke-direct {v2, v3, v4, v5}, Lcom/bweather/forecast/adapter/ˈ;-><init>(Ljava/util/ArrayList;Landroid/content/Context;Lcom/bumptech/glide/ˑ;)V

    invoke-static {v1, v2}, Lle;->ʻʻ(Lle;Lcom/bweather/forecast/adapter/ˈ;)Lcom/bweather/forecast/adapter/ˈ;

    iget-object v1, v0, Lle$ʼ;->ʽʽ:Lle;

    invoke-static {v1}, Lle;->ʽʽ(Lle;)Lit/sephiroth/android/library/widget/HListView;

    move-result-object v1

    iget-object v2, v0, Lle$ʼ;->ʽʽ:Lle;

    invoke-static {v2}, Lle;->ᴵᴵ(Lle;)Lcom/bweather/forecast/adapter/ˈ;
    ...
    new-instance v2, Lle$ʼ$ʻ;

    invoke-direct {v2, v0}, Lle$ʼ$ʻ;-><init>(Lle$ʼ;)V

    invoke-virtual {v1, v2}, Lit/sephiroth/android/library/widget/ʻ;->setOnItemClickListener(Lit/sephiroth/android/library/widget/ʻ$ʾ;)V
