...
.method static ʻ(Landroid/location/LocationManager;Landroid/location/GnssMeasurementsEvent$Callback;Landroid/os/Handler;)Z
    .locals 0
...
.method static ʼ(Landroid/location/LocationManager;Landroid/os/Handler;Ljava/util/concurrent/Executor;Lˆˋ$ʻ;)Z
    .locals 4
    .annotation build Landroidx/annotation/ᴵ;
    .end annotation
    ...
    new-instance v3, Lˆᐧ$ˑ;

    invoke-direct {v3, p3}, Lˆᐧ$ˑ;-><init>(Lˆˋ$ʻ;)V

    goto :goto_1

    :cond_1
    invoke-virtual {v3}, Lˆᐧ$ˑ;->ˋ()V

    :goto_1
    invoke-virtual {v3, p2}, Lˆᐧ$ˑ;->ˊ(Ljava/util/concurrent/Executor;)V
    ...
    invoke-virtual {v2, p3, v3}, Lٴٴ;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method static ʽ(Landroid/location/LocationManager;Landroid/location/GnssMeasurementsEvent$Callback;)V
    .locals 0
    .param p0    # Landroid/location/LocationManager;
        .annotation build Landroidx/annotation/ˉˉ;
        .end annotation
...
.method static ʾ(Landroid/location/LocationManager;Ljava/lang/Object;)V
    .locals 1
    .annotation build Landroidx/annotation/ᴵ;
    .end annotation

    instance-of v0, p1, Lˆᐧ$ˑ;
