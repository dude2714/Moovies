.class Landroid/support/v4/media/MediaBrowserCompat$ˊ;
.super Landroid/support/v4/media/MediaBrowserCompat$ˉ;
...
.method constructor <init>(Landroid/content/Context;Landroid/content/ComponentName;Landroid/support/v4/media/MediaBrowserCompat$ʽ;Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Landroid/support/v4/media/MediaBrowserCompat$ˉ;-><init>(Landroid/content/Context;Landroid/content/ComponentName;Landroid/support/v4/media/MediaBrowserCompat$ʽ;Landroid/os/Bundle;)V
...
.method public ˋ(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$ـ;)V
    ...
    iget v0, p0, Landroid/support/v4/media/MediaBrowserCompat$ˈ;->ˆ:I
    ...
    :cond_0
    invoke-super {p0, p1, p2, p3}, Landroid/support/v4/media/MediaBrowserCompat$ˈ;->ˋ(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$ـ;)V
...
.method public ˏ(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$ـ;)V
    ...
    :cond_0
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/MediaBrowserCompat$ˈ;->ˏ(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$ـ;)V
    ...
    iget-object p2, p2, Landroid/support/v4/media/MediaBrowserCompat$ـ;->ʻ:Landroid/media/browse/MediaBrowser$SubscriptionCallback;
