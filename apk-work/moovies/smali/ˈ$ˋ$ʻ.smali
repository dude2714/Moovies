...
.method public synthetic constructor <init>(Luh4;)V
    ...
    invoke-direct {p0}, Lˈ$ˋ$ʻ;-><init>()V
...
# virtual methods
.method public final ʽ(Landroid/content/Context;)Landroid/content/pm/ResolveInfo;
    .locals 2
...
.method public final ʾ(Landroid/content/Context;)Landroid/content/pm/ResolveInfo;
    .locals 2
    .param p1    # Landroid/content/Context;
        .annotation build Lro5;
        .end annotation
...
.method public final ʿ(Lˈ$ˋ$ˆ;)Ljava/lang/String;
    .locals 1
    .param p1    # Lˈ$ˋ$ˆ;
        .annotation build Lro5;
        .end annotation
    ...
    :cond_1
    instance-of v0, p1, Lˈ$ˋ$ʾ;

    if-eqz v0, :cond_2

    check-cast p1, Lˈ$ˋ$ʾ;

    invoke-virtual {p1}, Lˈ$ˋ$ʾ;->ʻ()Ljava/lang/String;
...
.method public final ˆ(Landroid/content/Context;)Z
    .locals 1
    .param p1    # Landroid/content/Context;
        .annotation build Lro5;
        .end annotation
    ...
    invoke-virtual {p0, p1}, Lˈ$ˋ$ʻ;->ʽ(Landroid/content/Context;)Landroid/content/pm/ResolveInfo;
...
.method public final ˉ(Landroid/content/Context;)Z
    .locals 1
    .param p1    # Landroid/content/Context;
        .annotation build Lro5;
        .end annotation
    ...
    invoke-virtual {p0, p1}, Lˈ$ˋ$ʻ;->ˊ(Landroid/content/Context;)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-virtual {p0, p1}, Lˈ$ˋ$ʻ;->ˆ(Landroid/content/Context;)Z
...
.method public final ˊ(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, p1}, Lˈ$ˋ$ʻ;->ʾ(Landroid/content/Context;)Landroid/content/pm/ResolveInfo;
