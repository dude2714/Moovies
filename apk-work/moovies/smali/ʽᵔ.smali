...
.method public static ʻ(Landroid/graphics/Bitmap;IILandroid/graphics/Rect;Z)Landroid/graphics/Bitmap;
    .locals 21
    ...
    invoke-static/range {p0 .. p0}, Lʽᵔ$ʽ;->ʻ(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v14}, Lʽᵔ$ʾ;->ʻ(Landroid/graphics/Paint;)V
    ...
    invoke-static/range {p0 .. p0}, Lʽᵔ$ʽ;->ʽ(Landroid/graphics/Bitmap;)Z
    ...
    invoke-static {v7, v1, v4, v9}, Lʽᵔ;->ʿ(IIII)I
    ...
    invoke-static {v8, v2, v4, v10}, Lʽᵔ;->ʿ(IIII)I
    ...
    :goto_a
    invoke-static {v11, v13, v0, v4}, Lʽᵔ$ʽ;->ʼ(IILandroid/graphics/Bitmap;Z)Landroid/graphics/Bitmap;
    ...
    invoke-static {v7, v1, v12, v9}, Lʽᵔ;->ʿ(IIII)I
    ...
    invoke-static {v11}, Lʽᵔ$ʽ;->ʽ(Landroid/graphics/Bitmap;)Z
    ...
    :goto_14
    invoke-static {v7, v1, v3, v9}, Lʽᵔ;->ʿ(IIII)I
    ...
    :goto_15
    invoke-static {v8, v2, v11, v10}, Lʽᵔ;->ʿ(IIII)I
    ...
    :goto_16
    invoke-static {v3, v11, v0, v5}, Lʽᵔ$ʽ;->ʼ(IILandroid/graphics/Bitmap;Z)Landroid/graphics/Bitmap;
...
.method public static ʼ(Landroid/graphics/Bitmap;)I
    .locals 2
    .param p0    # Landroid/graphics/Bitmap;
        .annotation build Landroidx/annotation/ˉˉ;
        .end annotation
    ...
    invoke-static {p0}, Lʽᵔ$ʼ;->ʻ(Landroid/graphics/Bitmap;)I
...
.method public static ʽ(Landroid/graphics/Bitmap;)Z
    .locals 2
    .param p0    # Landroid/graphics/Bitmap;
        .annotation build Landroidx/annotation/ˉˉ;
        .end annotation
    ...
    invoke-static {p0}, Lʽᵔ$ʻ;->ʻ(Landroid/graphics/Bitmap;)Z
...
.method public static ʾ(Landroid/graphics/Bitmap;Z)V
    .locals 2
    .param p0    # Landroid/graphics/Bitmap;
        .annotation build Landroidx/annotation/ˉˉ;
        .end annotation
    ...
    invoke-static {p0, p1}, Lʽᵔ$ʻ;->ʼ(Landroid/graphics/Bitmap;Z)V

    :cond_0
    return-void
.end method

.method public static ʿ(IIII)I
    .locals 1
