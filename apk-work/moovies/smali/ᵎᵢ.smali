...
# static fields
.field private static final ʻ:Ljava/lang/String; = "PrintHelper"

.field private static final ʼ:I = 0xdac

.field static final ʽ:Z

.field static final ʾ:Z
...
.field ˏ:Landroid/graphics/BitmapFactory$Options;

.field final ˑ:Ljava/lang/Object;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lᵎᵢ;->ˏ:Landroid/graphics/BitmapFactory$Options;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lᵎᵢ;->ˑ:Ljava/lang/Object;
    ...
    iput-object p1, p0, Lᵎᵢ;->ˎ:Landroid/content/Context;

    return-void
.end method

.method static ʻ(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    .locals 5
...
.method private static ʼ(Landroid/print/PrintAttributes;)Landroid/print/PrintAttributes$Builder;
    .locals 3
...
.method static ʾ(IILandroid/graphics/RectF;I)Landroid/graphics/Matrix;
    .locals 3
...
.method private ˉ(Landroid/net/Uri;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 4
    ...
    iget-object v2, p0, Lᵎᵢ;->ˎ:Landroid/content/Context;
...
.method ˊ(Landroid/net/Uri;)Landroid/graphics/Bitmap;
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/FileNotFoundException;
    ...
    iget-object v0, p0, Lᵎᵢ;->ˎ:Landroid/content/Context;
    ...
    invoke-direct {p0, p1, v0}, Lᵎᵢ;->ˉ(Landroid/net/Uri;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :cond_2
    iget-object v0, p0, Lᵎᵢ;->ˑ:Ljava/lang/Object;
    ...
    iput-object v2, p0, Lᵎᵢ;->ˏ:Landroid/graphics/BitmapFactory$Options;
    ...
    :try_start_1
    invoke-direct {p0, p1, v2}, Lᵎᵢ;->ˉ(Landroid/net/Uri;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :try_start_2
    iput-object v3, p0, Lᵎᵢ;->ˏ:Landroid/graphics/BitmapFactory$Options;
    ...
    iget-object v1, p0, Lᵎᵢ;->ˑ:Ljava/lang/Object;
...
.method public ˋ(Ljava/lang/String;Landroid/graphics/Bitmap;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, p2, v0}, Lᵎᵢ;->ˎ(Ljava/lang/String;Landroid/graphics/Bitmap;Lᵎᵢ$ʼ;)V

    return-void
.end method

.method public ˎ(Ljava/lang/String;Landroid/graphics/Bitmap;Lᵎᵢ$ʼ;)V
    .locals 9
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/ˉˉ;
        .end annotation
    ...
    invoke-static {p2}, Lᵎᵢ;->ˈ(Landroid/graphics/Bitmap;)Z
    ...
    invoke-direct/range {v2 .. v7}, Lᵎᵢ$ʽ;-><init>(Lᵎᵢ;Ljava/lang/String;ILandroid/graphics/Bitmap;Lᵎᵢ$ʼ;)V
...
.method public ˏ(Ljava/lang/String;Landroid/net/Uri;)V
    .locals 1
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/ˉˉ;
        .end annotation
    ...
    invoke-virtual {p0, p1, p2, v0}, Lᵎᵢ;->ˑ(Ljava/lang/String;Landroid/net/Uri;Lᵎᵢ$ʼ;)V

    return-void
.end method

.method public ˑ(Ljava/lang/String;Landroid/net/Uri;Lᵎᵢ$ʼ;)V
    .locals 8
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/ˉˉ;
        .end annotation
    ...
    invoke-direct/range {v2 .. v7}, Lᵎᵢ$ʾ;-><init>(Lᵎᵢ;Ljava/lang/String;Landroid/net/Uri;Lᵎᵢ$ʼ;I)V

    iget-object p2, p0, Lᵎᵢ;->ˎ:Landroid/content/Context;
...
.method ᴵ(Landroid/print/PrintAttributes;ILandroid/graphics/Bitmap;Landroid/os/ParcelFileDescriptor;Landroid/os/CancellationSignal;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
    .locals 11
    .annotation build Landroidx/annotation/ˑˑ;
        value = 0x13
    .end annotation

    sget-boolean v0, Lᵎᵢ;->ʾ:Z
    ...
    :cond_0
    invoke-static {p1}, Lᵎᵢ;->ʼ(Landroid/print/PrintAttributes;)Landroid/print/PrintAttributes$Builder;
    ...
    invoke-direct/range {v2 .. v10}, Lᵎᵢ$ʻ;-><init>(Lᵎᵢ;Landroid/os/CancellationSignal;Landroid/print/PrintAttributes;Landroid/graphics/Bitmap;Landroid/print/PrintAttributes;ILandroid/os/ParcelFileDescriptor;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
