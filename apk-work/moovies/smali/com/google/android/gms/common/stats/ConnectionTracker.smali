...
.field private static volatile ʼ:Lcom/google/android/gms/common/stats/ConnectionTracker;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/common/stats/ConnectionTracker;->ʻ:Ljava/lang/Object;
...
.method public static getInstance()Lcom/google/android/gms/common/stats/ConnectionTracker;
    ...
    sget-object v0, Lcom/google/android/gms/common/stats/ConnectionTracker;->ʼ:Lcom/google/android/gms/common/stats/ConnectionTracker;

    if-nez v0, :cond_1

    sget-object v0, Lcom/google/android/gms/common/stats/ConnectionTracker;->ʻ:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/google/android/gms/common/stats/ConnectionTracker;->ʼ:Lcom/google/android/gms/common/stats/ConnectionTracker;
    ...
    sput-object v1, Lcom/google/android/gms/common/stats/ConnectionTracker;->ʼ:Lcom/google/android/gms/common/stats/ConnectionTracker;
...
.method private static ʻ(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    .locals 0
...
.method private final ʼ(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
    .locals 3
    ...
    :cond_1
    :goto_0
    invoke-static {p4}, Lcom/google/android/gms/common/stats/ConnectionTracker;->ʽ(Landroid/content/ServiceConnection;)Z
    ...
    :cond_2
    :try_start_1
    invoke-static {p1, p3, p4, p5, p7}, Lcom/google/android/gms/common/stats/ConnectionTracker;->ʾ(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
...
.method private static ʽ(Landroid/content/ServiceConnection;)Z
    .locals 0
...
.method private static final ʾ(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    .locals 1
...
.method public bindService(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    invoke-direct/range {v1 .. v8}, Lcom/google/android/gms/common/stats/ConnectionTracker;->ʼ(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
...
.method public unbindService(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    invoke-static {p2}, Lcom/google/android/gms/common/stats/ConnectionTracker;->ʽ(Landroid/content/ServiceConnection;)Z
    ...
    invoke-static {p1, v0}, Lcom/google/android/gms/common/stats/ConnectionTracker;->ʻ(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_0
    invoke-static {p1, p2}, Lcom/google/android/gms/common/stats/ConnectionTracker;->ʻ(Landroid/content/Context;Landroid/content/ServiceConnection;)V
...
.method public final zza(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    invoke-direct/range {v0 .. v7}, Lcom/google/android/gms/common/stats/ConnectionTracker;->ʼ(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
