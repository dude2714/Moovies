...
.field private static final ʿ:Lcom/google/android/gms/common/GoogleApiAvailability;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/common/GoogleApiAvailability;->ʾ:Ljava/lang/Object;

    new-instance v0, Lcom/google/android/gms/common/GoogleApiAvailability;

    invoke-direct {v0}, Lcom/google/android/gms/common/GoogleApiAvailability;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/GoogleApiAvailability;->ʿ:Lcom/google/android/gms/common/GoogleApiAvailability;
...
.method public static getInstance()Lcom/google/android/gms/common/GoogleApiAvailability;
    ...
    sget-object v0, Lcom/google/android/gms/common/GoogleApiAvailability;->ʿ:Lcom/google/android/gms/common/GoogleApiAvailability;
...
.method public getErrorDialog(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/google/android/gms/common/GoogleApiAvailability;->ʻ(Landroid/content/Context;ILcom/google/android/gms/common/internal/zag;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public getErrorDialog(Landroidx/fragment/app/Fragment;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-virtual {p0, v1, p2, p1, p4}, Lcom/google/android/gms/common/GoogleApiAvailability;->ʻ(Landroid/content/Context;ILcom/google/android/gms/common/internal/zag;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public setDefaultNotificationChannelId(Landroid/content/Context;Ljava/lang/String;)V
    ...
    :cond_0
    sget-object p1, Lcom/google/android/gms/common/GoogleApiAvailability;->ʾ:Ljava/lang/Object;

    monitor-enter p1

    :try_start_0
    iput-object p2, p0, Lcom/google/android/gms/common/GoogleApiAvailability;->ˆ:Ljava/lang/String;
...
.method public showErrorDialogFragment(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Z
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/google/android/gms/common/GoogleApiAvailability;->ʼ(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public showErrorNotification(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0, p1, p2, v1, v0}, Lcom/google/android/gms/common/GoogleApiAvailability;->ʽ(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
...
.method public final zab(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-virtual {p0, p1, v0, v1, p2}, Lcom/google/android/gms/common/GoogleApiAvailability;->ʼ(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public final zag(Landroid/app/Activity;Lcom/google/android/gms/common/api/internal/LifecycleFragment;IILandroid/content/DialogInterface$OnCancelListener;)Z
    ...
    invoke-virtual {p0, p1, p3, p2, p5}, Lcom/google/android/gms/common/GoogleApiAvailability;->ʻ(Landroid/content/Context;ILcom/google/android/gms/common/internal/zag;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-virtual {p0, p1, p2, p3, p5}, Lcom/google/android/gms/common/GoogleApiAvailability;->ʼ(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public final zah(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;I)Z
    ...
    invoke-virtual {p0, p1, p2, v2, p3}, Lcom/google/android/gms/common/GoogleApiAvailability;->ʽ(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
...
.method final ʻ(Landroid/content/Context;ILcom/google/android/gms/common/internal/zag;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 5
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/ˉˉ;
        .end annotation
...
.method final ʼ(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    .locals 1
    .param p4    # Landroid/content/DialogInterface$OnCancelListener;
        .annotation build Landroidx/annotation/ˈˈ;
        .end annotation
...
.method final ʽ(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    .locals 8
    .param p3    # Ljava/lang/String;
        .annotation build Landroidx/annotation/ˈˈ;
        .end annotation
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/GoogleApiAvailability;->ʾ(Landroid/content/Context;)V
    ...
    new-instance v6, Landroidx/core/app/ᵢ$ˈ;

    invoke-direct {v6, p1}, Landroidx/core/app/ᵢ$ˈ;-><init>(Landroid/content/Context;)V

    invoke-virtual {v6, v3}, Landroidx/core/app/ᵢ$ˈ;->ʻˉ(Z)Landroidx/core/app/ᵢ$ˈ;

    move-result-object v6

    invoke-virtual {v6, v3}, Landroidx/core/app/ᵢ$ˈ;->ʽʽ(Z)Landroidx/core/app/ᵢ$ˈ;

    move-result-object v6

    invoke-virtual {v6, v0}, Landroidx/core/app/ᵢ$ˈ;->ˑˑ(Ljava/lang/CharSequence;)Landroidx/core/app/ᵢ$ˈ;

    move-result-object v0

    new-instance v6, Landroidx/core/app/ᵢ$ʿ;

    invoke-direct {v6}, Landroidx/core/app/ᵢ$ʿ;-><init>()V

    invoke-virtual {v6, v1}, Landroidx/core/app/ᵢ$ʿ;->ᐧᐧ(Ljava/lang/CharSequence;)Landroidx/core/app/ᵢ$ʿ;

    move-result-object v6

    invoke-virtual {v0, v6}, Landroidx/core/app/ᵢ$ˈ;->ʼʿ(Landroidx/core/app/ᵢ$ᐧ;)Landroidx/core/app/ᵢ$ˈ;
    ...
    invoke-virtual {v0, v1}, Landroidx/core/app/ᵢ$ˈ;->ʻﹳ(I)Landroidx/core/app/ᵢ$ˈ;

    move-result-object v1

    invoke-virtual {v1, p3}, Landroidx/core/app/ᵢ$ˈ;->ʻי(I)Landroidx/core/app/ᵢ$ˈ;
    ...
    invoke-virtual {v0, v1, v4, p4}, Landroidx/core/app/ᵢ$ˈ;->ʻ(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroidx/core/app/ᵢ$ˈ;

    goto :goto_0

    :cond_3
    invoke-virtual {v0, p4}, Landroidx/core/app/ᵢ$ˈ;->ˏˏ(Landroid/app/PendingIntent;)Landroidx/core/app/ᵢ$ˈ;
    ...
    invoke-virtual {v0, v6}, Landroidx/core/app/ᵢ$ˈ;->ʻﹳ(I)Landroidx/core/app/ᵢ$ˈ;
    ...
    invoke-virtual {v6, v4}, Landroidx/core/app/ᵢ$ˈ;->ʼˈ(Ljava/lang/CharSequence;)Landroidx/core/app/ᵢ$ˈ;
    ...
    invoke-virtual {v4, v6, v7}, Landroidx/core/app/ᵢ$ˈ;->ʼˑ(J)Landroidx/core/app/ᵢ$ˈ;

    move-result-object v4

    invoke-virtual {v4, p4}, Landroidx/core/app/ᵢ$ˈ;->ˏˏ(Landroid/app/PendingIntent;)Landroidx/core/app/ᵢ$ˈ;

    move-result-object p4

    invoke-virtual {p4, v1}, Landroidx/core/app/ᵢ$ˈ;->ˎˎ(Ljava/lang/CharSequence;)Landroidx/core/app/ᵢ$ˈ;
    ...
    sget-object p4, Lcom/google/android/gms/common/GoogleApiAvailability;->ʾ:Ljava/lang/Object;

    monitor-enter p4

    :try_start_0
    iget-object v1, p0, Lcom/google/android/gms/common/GoogleApiAvailability;->ˆ:Ljava/lang/String;
    ...
    :cond_7
    :goto_1
    invoke-virtual {v0, v1}, Landroidx/core/app/ᵢ$ˈ;->ــ(Ljava/lang/String;)Landroidx/core/app/ᵢ$ˈ;
...
.method final ʾ(Landroid/content/Context;)V
    .locals 3

    new-instance v0, Lcom/google/android/gms/common/ʼ;

    invoke-direct {v0, p0, p1}, Lcom/google/android/gms/common/ʼ;-><init>(Lcom/google/android/gms/common/GoogleApiAvailability;Landroid/content/Context;)V
