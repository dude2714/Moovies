...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/cast/framework/media/widget/zzs;->ʻ:Lcom/google/android/gms/cast/internal/Logger;
...
.method public static zza(Landroid/content/Context;Landroid/graphics/Bitmap;FF)Landroid/graphics/Bitmap;
    ...
    sget-object p2, Lcom/google/android/gms/cast/framework/media/widget/zzs;->ʻ:Lcom/google/android/gms/cast/internal/Logger;
...
.method public static zzb(Landroid/content/Context;II)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1, p2, v0, v1}, Lcom/google/android/gms/cast/framework/media/widget/zzs;->ʻ(Landroid/content/Context;IIII)Landroid/graphics/drawable/Drawable;
...
.method private static ʻ(Landroid/content/Context;IIII)Landroid/graphics/drawable/Drawable;
    .locals 2
    .param p2    # I
        .annotation build Landroidx/annotation/ᵎ;
        .end annotation
    ...
    invoke-static {p2}, Landroidx/core/graphics/drawable/ʽ;->ᴵ(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    sget-object v0, Landroid/graphics/PorterDuff$Mode;->SRC_IN:Landroid/graphics/PorterDuff$Mode;

    invoke-static {p2, v0}, Landroidx/core/graphics/drawable/ʽ;->ٴ(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    :cond_1
    invoke-static {p0, p4}, Landroidx/core/content/ᐧᐧ;->ˆ(Landroid/content/Context;I)I
    ...
    invoke-static {p3, p0}, Lʾʼ;->ᴵᴵ(II)I
    ...
    :goto_1
    invoke-static {p2, p0}, Landroidx/core/graphics/drawable/ʽ;->ـ(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
