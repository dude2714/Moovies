...
.method constructor <init>(Lـﹳ;Landroid/content/Context;Landroid/net/Uri;)V
    ...
    iput-object p2, p0, Lٴʼ;->ʽ:Landroid/content/Context;

    iput-object p3, p0, Lٴʼ;->ʾ:Landroid/net/Uri;

    return-void
.end method

.method private static ﹳ(Ljava/lang/AutoCloseable;)V
    .locals 0
...
.method private static ﹶ(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    .locals 0
    .annotation build Landroidx/annotation/ˈˈ;
    .end annotation
...
.method public ʻ()Z
    ...
    iget-object v0, p0, Lٴʼ;->ʽ:Landroid/content/Context;

    iget-object v1, p0, Lٴʼ;->ʾ:Landroid/net/Uri;
...
.method public ʽ(Ljava/lang/String;)Lـﹳ;
    ...
    invoke-static {v0, v1, v2, p1}, Lٴʼ;->ﹶ(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    ...
    iget-object v1, p0, Lٴʼ;->ʽ:Landroid/content/Context;

    invoke-direct {v0, p0, v1, p1}, Lٴʼ;-><init>(Lـﹳ;Landroid/content/Context;Landroid/net/Uri;)V
...
.method public ʾ(Ljava/lang/String;Ljava/lang/String;)Lـﹳ;
    ...
    invoke-static {v0, v1, p1, p2}, Lٴʼ;->ﹶ(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-direct {p2, p0, v0, p1}, Lٴʼ;-><init>(Lـﹳ;Landroid/content/Context;Landroid/net/Uri;)V
...
.method public י()Landroid/net/Uri;
    ...
    iget-object v0, p0, Lٴʼ;->ʾ:Landroid/net/Uri;
...
.method public ᵢ()[Lـﹳ;
    ...
    iget-object v2, p0, Lٴʼ;->ʾ:Landroid/net/Uri;
    ...
    :cond_0
    :goto_1
    invoke-static {v8}, Lٴʼ;->ﹳ(Ljava/lang/AutoCloseable;)V
    ...
    iget-object v3, p0, Lٴʼ;->ʽ:Landroid/content/Context;

    aget-object v4, v0, v7

    invoke-direct {v2, p0, v3, v4}, Lٴʼ;-><init>(Lـﹳ;Landroid/content/Context;Landroid/net/Uri;)V
...
.method public ⁱ(Ljava/lang/String;)Z
    ...
    iput-object p1, p0, Lٴʼ;->ʾ:Landroid/net/Uri;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
