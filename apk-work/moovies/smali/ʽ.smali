...
# direct methods
.method public static final ʻ(Lʻ;Llg4;Lwa4;)Ljava/lang/Object;
    .locals 3
    .param p0    # Lʻ;
    ...
    invoke-interface {p0}, Lʻ;->peekAvailableContext()Landroid/content/Context;
    ...
    new-instance v1, Lʽ$ʼ;

    invoke-direct {v1, v0, p1}, Lʽ$ʼ;-><init>(Lkr4;Llg4;)V

    invoke-interface {p0, v1}, Lʻ;->addOnContextAvailableListener(Lʾ;)V

    new-instance p1, Lʽ$ʻ;

    invoke-direct {p1, p0, v1}, Lʽ$ʻ;-><init>(Lʻ;Lʽ$ʼ;)V

    invoke-interface {v0, p1}, Lkr4;->ᵎ(Llg4;)V
...
.method private static final ʼ(Lʻ;Llg4;Lwa4;)Ljava/lang/Object;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
