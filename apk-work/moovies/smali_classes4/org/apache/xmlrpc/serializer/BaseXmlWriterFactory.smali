...
.method public getXmlWriter(Lorg/apache/xmlrpc/common/XmlRpcStreamConfig;Ljava/io/OutputStream;)Lorg/xml/sax/ContentHandler;
    ...
    invoke-virtual {p0}, Lorg/apache/xmlrpc/serializer/BaseXmlWriterFactory;->newXmlWriter()Lrn5;

    move-result-object v0

    const/4 v1, 0x1

    invoke-interface {v0, v1}, Lrn5;->ˉ(Z)V
    ...
    :cond_0
    invoke-interface {v0, p1}, Lrn5;->ˊ(Ljava/lang/String;)V

    const/4 v2, 0x0

    invoke-interface {v0, v2}, Lrn5;->י(Z)V

    invoke-interface {v0, v1}, Lrn5;->ʻ(Z)V
    ...
    invoke-interface {v0, v1}, Lrn5;->ʾ(Ljava/io/Writer;)V
    :try_end_0
