...
.method public write(Lorg/xml/sax/ContentHandler;Ljava/lang/Object;)V
    ...
    invoke-interface {p1, v1, v3, v4, v0}, Lorg/xml/sax/ContentHandler;->startElement(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lorg/xml/sax/Attributes;)V

    const/16 v0, 0x400

    new-array v0, v0, [C

    new-instance v5, Lxn5$ʿ;

    const/4 v6, 0x0

    const/4 v7, 0x0

    invoke-direct {v5, v0, v6, v7, p1}, Lxn5$ʿ;-><init>([CILjava/lang/String;Lorg/xml/sax/ContentHandler;)V

    :try_start_0
    new-instance v0, Lxn5$ʾ;

    invoke-direct {v0, v5}, Lxn5$ʾ;-><init>(Lxn5$ʽ;)V
    ...
    invoke-interface {p1, v1, v3, v4}, Lorg/xml/sax/ContentHandler;->endElement(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
