...
# static fields
.field private static final ʽʽ:I = 0x8000
...
.method private constructor <init>(Ljava/io/InputStream;II)V
    ...
    iput p3, p0, Lhp5;->ʿʿ:I

    iput p3, p0, Lhp5;->ˆˆ:I
    ...
    :goto_1
    iput-boolean p1, p0, Lhp5;->ʼʼ:Z

    invoke-static {}, Ljava/lang/System;->nanoTime()J

    move-result-wide p1

    iput-wide p1, p0, Lhp5;->ʾʾ:J
...
.method private ʾ()Z
    ...
    iget-wide v3, p0, Lhp5;->ʾʾ:J

    sub-long/2addr v0, v3

    iget-wide v3, p0, Lhp5;->ــ:J
...
.method public static ˋ(Ljava/io/InputStream;II)Lhp5;
    .locals 1
    ...
    invoke-direct {v0, p0, p1, p2}, Lhp5;-><init>(Ljava/io/InputStream;II)V
...
.method public read([BII)I
    ...
    iget-boolean v0, p0, Lhp5;->ˉˉ:Z

    const/4 v1, -0x1

    if-nez v0, :cond_4

    iget-boolean v0, p0, Lhp5;->ʼʼ:Z

    if-eqz v0, :cond_0

    iget v0, p0, Lhp5;->ˆˆ:I
    ...
    iput-boolean p1, p0, Lhp5;->ˉˉ:Z

    return v1

    :cond_1
    invoke-direct {p0}, Lhp5;->ʾ()Z
    ...
    iget p2, p0, Lhp5;->ˆˆ:I

    sub-int/2addr p2, p1

    iput p2, p0, Lhp5;->ˆˆ:I
    :try_end_0
...
.method public reset()V
    ...
    iget v0, p0, Lhp5;->ʿʿ:I

    iget v1, p0, Ljava/io/BufferedInputStream;->markpos:I

    sub-int/2addr v0, v1

    iput v0, p0, Lhp5;->ˆˆ:I

    return-void
.end method

.method public ʿ(I)Ljava/nio/ByteBuffer;
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {v2, v3}, Lfp5;->ʿ(ZLjava/lang/String;)V
