...
.method protected static ʽ(Ljava/lang/CharSequence;II)I
    .locals 7
...
.method public ʼ(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v1, v0}, Le41;->ˈ(Ljava/lang/CharSequence;II)I
    ...
    :cond_0
    invoke-virtual {p0, p1, v1}, Le41;->ʿ(Ljava/lang/String;I)Ljava/lang/String;
...
.method protected abstract ʾ(I)[C
.end method

.method protected final ʿ(Ljava/lang/String;I)Ljava/lang/String;
    .locals 11
    ...
    invoke-static {p1, p2, v0}, Le41;->ʽ(Ljava/lang/CharSequence;II)I

    move-result v5

    if-ltz v5, :cond_5

    invoke-virtual {p0, v5}, Le41;->ʾ(I)[C
    ...
    invoke-static {v1, v4, v9}, Le41;->ˆ([CII)[C
    ...
    :cond_4
    invoke-virtual {p0, p1, v5, v0}, Le41;->ˈ(Ljava/lang/CharSequence;II)I
    ...
    invoke-static {v1, v4, p2}, Le41;->ˆ([CII)[C
...
.method protected ˈ(Ljava/lang/CharSequence;II)I
    .locals 2

    :goto_0
    if-ge p2, p3, :cond_2

    invoke-static {p1, p2, p3}, Le41;->ʽ(Ljava/lang/CharSequence;II)I

    move-result v0

    if-ltz v0, :cond_2

    invoke-virtual {p0, v0}, Le41;->ʾ(I)[C
