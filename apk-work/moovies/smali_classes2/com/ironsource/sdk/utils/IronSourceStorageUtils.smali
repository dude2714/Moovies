...
.field private static b:Lcom/ironsource/vu;
...
.method private static a(Landroid/content/Context;)V
    ...
    sget-object v0, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->b:Lcom/ironsource/vu;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/ironsource/vu;->b()Z
    ...
    invoke-virtual {v0}, Lcom/ironsource/vu;->c()Z
...
.method private static a()Z
    ...
    invoke-virtual {v0}, Lcom/ironsource/vu;->a()Z
...
.method private static b(Landroid/content/Context;)Ljava/io/File;
    ...
    sget-object v1, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->b:Lcom/ironsource/vu;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lcom/ironsource/vu;->d()Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-interface {v0, p0}, Lcom/ironsource/vf;->e(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_0
    invoke-interface {v0, p0}, Lcom/ironsource/vf;->u(Landroid/content/Context;)Ljava/io/File;
...
.method public static buildFilesMapOfDirectory(Lcom/ironsource/vh;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    .locals 6
    ...
    invoke-direct {v4, v3}, Lcom/ironsource/vh;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v4, p1}, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->buildFilesMapOfDirectory(Lcom/ironsource/vh;Lorg/json/JSONObject;)Lorg/json/JSONObject;
...
.method private static c(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-interface {v0, p0}, Lcom/ironsource/vf;->k(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_0
    invoke-interface {v0, p0}, Lcom/ironsource/vf;->x(Landroid/content/Context;)Ljava/io/File;
...
.method public static declared-synchronized deleteFile(Lcom/ironsource/vh;)Z
    .locals 2
...
.method public static getFilesInFolderRecursive(Lcom/ironsource/vh;)Ljava/util/ArrayList;
    .locals 5
    ...
    invoke-static {v4}, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->getFilesInFolderRecursive(Lcom/ironsource/vh;)Ljava/util/ArrayList;
...
.method public static getTotalSizeOfDir(Lcom/ironsource/vh;)J
    .locals 6
    ...
    invoke-direct {v5, v4}, Lcom/ironsource/vh;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v5}, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->getTotalSizeOfDir(Lcom/ironsource/vh;)J
...
.method public static initializeCacheDirectory(Landroid/content/Context;Lcom/ironsource/vu;)V
    .locals 0
    .param p0    # Landroid/content/Context;
        .annotation build Lro5;
        .end annotation
    .end param
    .param p1    # Lcom/ironsource/vu;
        .annotation build Lro5;
        .end annotation
    .end param

    sput-object p1, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->b:Lcom/ironsource/vu;
...
.method public static readFile(Lcom/ironsource/vh;)Ljava/lang/String;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
