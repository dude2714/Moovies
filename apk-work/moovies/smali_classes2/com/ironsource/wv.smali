.class public final Lcom/ironsource/wv;
.super Ljava/lang/Object;

# interfaces
.implements Lcom/ironsource/iv;
...
.annotation runtime Ln34;
    ...
    d2 = {
        ...
        "jsonData",
        "<init>",
        "(Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;Lcom/ironsource/oi;Lorg/json/JSONObject;Ljava/lang/String;)V",
...
.field private final g:Lcom/ironsource/ei;
    .annotation build Lro5;
    .end annotation
.end field
...
# direct methods
.method public constructor <init>(Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;Lcom/ironsource/oi;Lorg/json/JSONObject;Ljava/lang/String;)V
    .locals 2
    .param p1    # Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;
        .annotation build Lro5;
        .end annotation
    .end param
    .param p2    # Lcom/ironsource/oi;
        .annotation build Lro5;
        .end annotation
    .end param
    ...
    iput-object v0, p0, Lcom/ironsource/wv;->a:Landroid/os/Handler;

    new-instance v0, Landroid/webkit/WebView;

    invoke-direct {v0, p1}, Landroid/webkit/WebView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/ironsource/wv;->b:Landroid/webkit/WebView;

    new-instance v0, Landroid/webkit/WebView;

    invoke-direct {v0, p1}, Landroid/webkit/WebView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/ironsource/wv;->c:Landroid/webkit/WebView;

    iput-object p3, p0, Lcom/ironsource/wv;->d:Lorg/json/JSONObject;
    ...
    invoke-interface {p3}, Lcom/ironsource/fg;->t()Lcom/ironsource/ei;

    move-result-object p3

    iput-object p3, p0, Lcom/ironsource/wv;->g:Lcom/ironsource/ei;

    invoke-direct {p0, p1, p2, p4}, Lcom/ironsource/wv;->a(Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;Lcom/ironsource/oi;Ljava/lang/String;)V

    return-void
.end method

.method public static final synthetic a(Lcom/ironsource/wv;)Landroid/os/Handler;
    .locals 0

    iget-object p0, p0, Lcom/ironsource/wv;->a:Landroid/os/Handler;

    return-object p0
.end method

.method private final a(Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;Lcom/ironsource/oi;Ljava/lang/String;)V
    .locals 5
    ...
    iget-object v0, p0, Lcom/ironsource/wv;->b:Landroid/webkit/WebView;
    ...
    :goto_1
    iget-object v0, p0, Lcom/ironsource/wv;->c:Landroid/webkit/WebView;
    ...
    invoke-static {v0}, Ld74;->ˑˑ([Ljava/lang/Object;)Ljava/util/List;

    move-result-object v0

    iget-object v2, p0, Lcom/ironsource/wv;->g:Lcom/ironsource/ei;

    invoke-interface {v2}, Lcom/ironsource/ei;->a()Lcom/ironsource/fm;
    ...
    invoke-virtual {v2}, Lcom/ironsource/mediationsdk/p;->m()Ljava/util/List;
    ...
    check-cast v4, Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;
    ...
    :cond_3
    new-instance v2, Lcom/ironsource/dv$a;

    invoke-direct {v2}, Lcom/ironsource/dv$a;-><init>()V

    iget-object v4, p0, Lcom/ironsource/wv;->a:Landroid/os/Handler;

    invoke-virtual {v2, v0, p1, v4}, Lcom/ironsource/dv$a;->a(Ljava/util/List;Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;Landroid/os/Handler;)Lcom/ironsource/dv;

    move-result-object p1

    new-instance v0, Lcom/ironsource/wv$b;

    invoke-direct {v0, p0, p2}, Lcom/ironsource/wv$b;-><init>(Lcom/ironsource/wv;Lcom/ironsource/oi;)V

    iget-object v2, p0, Lcom/ironsource/wv;->c:Landroid/webkit/WebView;

    new-instance v4, Lcom/ironsource/hv;

    invoke-direct {v4, p1, v0, p0}, Lcom/ironsource/hv;-><init>(Lcom/ironsource/dv;Lcom/ironsource/oi;Lcom/ironsource/iv;)V

    const-string p1, "TestSuiteBridge"

    invoke-virtual {v2, v4, p1}, Landroid/webkit/WebView;->addJavascriptInterface(Ljava/lang/Object;Ljava/lang/String;)V

    iget-object p1, p0, Lcom/ironsource/wv;->c:Landroid/webkit/WebView;

    new-instance v0, Lcom/ironsource/wv$a;

    invoke-direct {v0, p0, p3}, Lcom/ironsource/wv$a;-><init>(Lcom/ironsource/wv;Ljava/lang/String;)V
    ...
    :cond_6
    iget-object p1, p0, Lcom/ironsource/wv;->b:Landroid/webkit/WebView;
    ...
    :cond_7
    iget-object p1, p0, Lcom/ironsource/wv;->a:Landroid/os/Handler;

    new-instance p3, Lcom/ironsource/ʿˑ;

    invoke-direct {p3, p0}, Lcom/ironsource/ʿˑ;-><init>(Lcom/ironsource/wv;)V
    ...
    new-instance p3, Lcom/ironsource/ʿי;

    invoke-direct {p3, p2}, Lcom/ironsource/ʿי;-><init>(Lcom/ironsource/oi;)V
...
.method private static final a(Lcom/ironsource/oi;)V
    .locals 1
    ...
    invoke-interface {p0}, Lcom/ironsource/oi;->onUIReady()V

    return-void
.end method

.method private static final a(Lcom/ironsource/wv;Ljava/lang/String;)V
    .locals 2
    ...
    iget-object p0, p0, Lcom/ironsource/wv;->c:Landroid/webkit/WebView;
...
.method public static final synthetic a(Lcom/ironsource/wv;Z)V
    .locals 0

    iput-boolean p1, p0, Lcom/ironsource/wv;->e:Z

    return-void
.end method

.method public static final synthetic b(Lcom/ironsource/wv;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/ironsource/wv;->e:Z

    return p0
.end method

.method public static final synthetic c(Lcom/ironsource/wv;)Lorg/json/JSONObject;
    .locals 0

    iget-object p0, p0, Lcom/ironsource/wv;->d:Lorg/json/JSONObject;

    return-object p0
.end method

.method public static final synthetic d(Lcom/ironsource/wv;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/ironsource/wv;->f:Z

    return p0
.end method

.method private static final e(Lcom/ironsource/wv;)V
    .locals 1
    ...
    iput-boolean v0, p0, Lcom/ironsource/wv;->f:Z

    return-void
.end method

.method public static synthetic ʻ(Lcom/ironsource/wv;)V
    .locals 0

    invoke-static {p0}, Lcom/ironsource/wv;->e(Lcom/ironsource/wv;)V

    return-void
.end method

.method public static synthetic ʼ(Lcom/ironsource/oi;)V
    .locals 0

    invoke-static {p0}, Lcom/ironsource/wv;->a(Lcom/ironsource/oi;)V

    return-void
.end method

.method public static synthetic ʽ(Lcom/ironsource/wv;Ljava/lang/String;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/ironsource/wv;->a(Lcom/ironsource/wv;Ljava/lang/String;)V
...
.method public final a(Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p2}, Lcom/ironsource/vv;->b(Ljava/util/List;)Ljava/lang/String;
...
.method public final a(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/ironsource/wv;->a:Landroid/os/Handler;

    new-instance v1, Lcom/ironsource/ʿـ;

    invoke-direct {v1, p0, p1}, Lcom/ironsource/ʿـ;-><init>(Lcom/ironsource/wv;Ljava/lang/String;)V
...
.method public a(Ljava/lang/String;Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;Ljava/util/List;)V
    ...
    iget-boolean v0, p0, Lcom/ironsource/wv;->e:Z
    ...
    invoke-virtual {p0, p2, p1}, Lcom/ironsource/wv;->a(Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/ironsource/wv;->a(Ljava/lang/String;)V
