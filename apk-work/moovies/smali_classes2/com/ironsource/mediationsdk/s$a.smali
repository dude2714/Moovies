...
.method public run()V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/ironsource/ke;->a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v1}, Lcom/ironsource/mediationsdk/s;->l(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/hk;
    ...
    invoke-virtual {v1, v2}, Lcom/ironsource/hk;->i(Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Lcom/ironsource/er;->a()V
    ...
    invoke-virtual {v0, v2, v3, v4}, Lcom/ironsource/mediationsdk/p;->b(Landroid/content/Context;Ljava/lang/String;Lcom/ironsource/mediationsdk/p$c;)Lcom/ironsource/qt;

    move-result-object v2

    invoke-static {v1, v2}, Lcom/ironsource/mediationsdk/s;->a(Lcom/ironsource/mediationsdk/s;Lcom/ironsource/qt;)Lcom/ironsource/qt;

    iget-object v1, p0, Lcom/ironsource/mediationsdk/s$a;->e:Lcom/ironsource/mediationsdk/s;

    invoke-static {v1}, Lcom/ironsource/mediationsdk/s;->n(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/qt;
    ...
    invoke-virtual {v1}, Lcom/ironsource/qt;->p()Z
    ...
    invoke-static {v2}, Lcom/ironsource/mediationsdk/s;->n(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/qt;
    ...
    invoke-virtual {v0}, Lcom/ironsource/mediationsdk/p;->z()Z

    move-result v3

    invoke-virtual {v1, v2, v3}, Lcom/ironsource/pn;->a(Ljava/util/Map;Z)V
    ...
    invoke-virtual {v1}, Lcom/ironsource/z3;->f()Lcom/ironsource/j4;
    ...
    invoke-virtual {v1}, Lcom/ironsource/j4;->g()Z

    move-result v3

    invoke-virtual {v2, v3}, Lcom/ironsource/xa;->c(Z)V

    invoke-virtual {v1}, Lcom/ironsource/j4;->f()Z

    move-result v3

    invoke-virtual {v2, v3}, Lcom/ironsource/xa;->a(Z)V

    invoke-virtual {v1}, Lcom/ironsource/j4;->j()I
    ...
    invoke-virtual {v1}, Lcom/ironsource/j4;->h()Z
    ...
    invoke-static {v2}, Lcom/ironsource/mediationsdk/s;->p(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/jf;

    move-result-object v2

    invoke-interface {v2, v1}, Lcom/ironsource/jf;->a(Lcom/ironsource/j4;)V
    ...
    invoke-static {v4}, Lcom/ironsource/mediationsdk/s;->n(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/qt;

    move-result-object v4

    invoke-virtual {v2, v3, v4}, Lcom/ironsource/mediationsdk/s;->a(Landroid/content/Context;Lcom/ironsource/qt;)V
    ...
    invoke-virtual {v4}, Lcom/ironsource/qt;->h()Lcom/ironsource/qt$a;

    move-result-object v4

    invoke-virtual {v0, v2, v3, v4}, Lcom/ironsource/mediationsdk/p;->a(JLcom/ironsource/qt$a;)V
    ...
    sget-object v2, Lcom/ironsource/mediationsdk/ʻ;->ʽʽ:Lcom/ironsource/mediationsdk/ʻ;
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/ironsource/gr;-><init>(Lcom/ironsource/zf;Lag4;Lcom/ironsource/fg;Ljava/util/concurrent/Executor;)V
    ...
    invoke-virtual {v0, v1}, Lcom/ironsource/gr;->c(Landroid/content/Context;)V
    ...
    invoke-static {v0, v1}, Lcom/ironsource/mediationsdk/s;->a(Lcom/ironsource/mediationsdk/s;Lcom/ironsource/tt;)Lcom/ironsource/tt;

    iget-object v0, p0, Lcom/ironsource/mediationsdk/s$a;->e:Lcom/ironsource/mediationsdk/s;

    invoke-static {v0}, Lcom/ironsource/mediationsdk/s;->q(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/tt;

    move-result-object v0

    iget-object v1, p0, Lcom/ironsource/mediationsdk/s$a;->e:Lcom/ironsource/mediationsdk/s;

    invoke-static {v1}, Lcom/ironsource/mediationsdk/s;->p(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/jf;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/ironsource/tt;->a(Lcom/ironsource/jf;)V

    iget-object v0, p0, Lcom/ironsource/mediationsdk/s$a;->e:Lcom/ironsource/mediationsdk/s;

    invoke-static {v0}, Lcom/ironsource/mediationsdk/s;->n(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/qt;
    ...
    invoke-virtual {v0}, Lcom/ironsource/z3;->g()Z
    ...
    invoke-virtual {v0}, Lcom/ironsource/qt;->g()Ljava/util/List;
    ...
    check-cast v2, Lcom/ironsource/op;
    ...
    invoke-interface {v2, v0, v3, v4}, Lcom/ironsource/op;->a(Ljava/util/List;ZLcom/ironsource/u8;)V
    ...
    invoke-virtual {v0}, Lcom/ironsource/kq$a;->a()V
    ...
    invoke-virtual {v0}, Lcom/ironsource/z3;->j()Lcom/ironsource/rt;

    move-result-object v0

    if-eqz v0, :cond_6

    invoke-virtual {v0}, Lcom/ironsource/rt;->c()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/ironsource/z3;->d()Lcom/ironsource/d4;

    move-result-object v0

    invoke-virtual {v0}, Lcom/ironsource/d4;->f()Z
    ...
    invoke-virtual {v0}, Lcom/ironsource/d4;->b()Ljava/util/HashSet;

    move-result-object v3

    invoke-virtual {v0}, Lcom/ironsource/d4;->d()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v0}, Lcom/ironsource/d4;->c()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v0}, Lcom/ironsource/d4;->e()Z

    move-result v6

    invoke-virtual {v0}, Lcom/ironsource/d4;->a()I

    move-result v8

    invoke-virtual {v0}, Lcom/ironsource/d4;->g()Z

    move-result v9

    invoke-virtual/range {v2 .. v9}, Lcom/ironsource/q9;->a(Ljava/util/HashSet;Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;IZ)V
    ...
    check-cast v1, Lcom/ironsource/op;

    const-string v2, "serverResponseIsNotValid"

    invoke-interface {v1, v2}, Lcom/ironsource/op;->d(Ljava/lang/String;)V
    ...
    invoke-interface {v1}, Lcom/ironsource/op;->a()V
    ...
    invoke-interface {v1, v3}, Lcom/ironsource/op;->d(Ljava/lang/String;)V
