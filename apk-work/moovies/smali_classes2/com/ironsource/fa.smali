...
# static fields
.field private static f:Lcom/ironsource/fa; = null
...
# instance fields
.field private final a:Lcom/ironsource/ga;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    invoke-direct {p1}, Lcom/ironsource/ga;-><init>()V

    iput-object p1, p0, Lcom/ironsource/fa;->a:Lcom/ironsource/ga;

    const/4 p1, 0x4

    iput p1, p0, Lcom/ironsource/fa;->b:I

    const/16 p1, 0x190

    iput p1, p0, Lcom/ironsource/fa;->c:I

    const-string p1, "DROP TABLE IF EXISTS events"

    iput-object p1, p0, Lcom/ironsource/fa;->d:Ljava/lang/String;

    const-string p1, "CREATE TABLE events (_id INTEGER PRIMARY KEY,eventid INTEGER,timestamp INTEGER,type TEXT,data TEXT )"

    iput-object p1, p0, Lcom/ironsource/fa;->e:Ljava/lang/String;

    return-void
.end method

.method private a(Lcom/ironsource/zb;Ljava/lang/String;)Landroid/content/ContentValues;
    .locals 3
    ...
    invoke-virtual {p1}, Lcom/ironsource/zb;->d()J
    ...
    invoke-virtual {p1}, Lcom/ironsource/zb;->a()Ljava/lang/String;
...
.method private declared-synchronized a(Z)Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_0
    iget-object v3, p0, Lcom/ironsource/fa;->a:Lcom/ironsource/ga;

    invoke-virtual {v3, v2, p0}, Lcom/ironsource/ga;->a(ZLandroid/database/sqlite/SQLiteOpenHelper;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-virtual {v3, v0, p0}, Lcom/ironsource/ga;->a(ZLandroid/database/sqlite/SQLiteOpenHelper;)Landroid/database/sqlite/SQLiteDatabase;
...
.method public static declared-synchronized a(Landroid/content/Context;Ljava/lang/String;I)Lcom/ironsource/fa;
    .locals 2
    ...
    :try_start_0
    sget-object v1, Lcom/ironsource/fa;->f:Lcom/ironsource/fa;

    if-nez v1, :cond_0

    new-instance v1, Lcom/ironsource/fa;

    invoke-direct {v1, p0, p1, p2}, Lcom/ironsource/fa;-><init>(Landroid/content/Context;Ljava/lang/String;I)V

    sput-object v1, Lcom/ironsource/fa;->f:Lcom/ironsource/fa;

    :cond_0
    sget-object p0, Lcom/ironsource/fa;->f:Lcom/ironsource/fa;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized a(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    :try_start_1
    invoke-direct {p0, v1}, Lcom/ironsource/fa;->a(Z)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct {v5, p1, v3, v4, v1}, Lcom/ironsource/zb;-><init>(IJLjava/lang/String;)V
...
.method public declared-synchronized a(Ljava/util/List;Ljava/lang/String;)V
    ...
    :try_start_1
    invoke-direct {p0, v0}, Lcom/ironsource/fa;->a(Z)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct {p0, v2, p2}, Lcom/ironsource/fa;->a(Lcom/ironsource/zb;Ljava/lang/String;)Landroid/content/ContentValues;
...
.method public declared-synchronized b(Ljava/lang/String;)V
    ...
    :try_start_1
    invoke-direct {p0, v2}, Lcom/ironsource/fa;->a(Z)Landroid/database/sqlite/SQLiteDatabase;
...
.method public onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    invoke-virtual {p0, p1}, Lcom/ironsource/fa;->onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
