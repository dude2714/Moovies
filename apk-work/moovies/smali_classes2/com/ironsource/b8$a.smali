...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/ironsource/b8;->a(Ljava/util/List;Lcom/ironsource/b8$b;JLjava/util/concurrent/TimeUnit;)V
.end annotation
...
# instance fields
.field final synthetic a:Lcom/ironsource/b8$b;

.field final synthetic b:Lcom/ironsource/b8;


# direct methods
.method constructor <init>(Lcom/ironsource/b8;Lcom/ironsource/b8$b;)V
    .locals 0

    iput-object p1, p0, Lcom/ironsource/b8$a;->b:Lcom/ironsource/b8;

    iput-object p2, p0, Lcom/ironsource/b8$a;->a:Lcom/ironsource/b8$b;
...
.method public onWorkCompleted(Ljava/util/List;J)V
    ...
    check-cast v2, Lcom/ironsource/y7;

    invoke-virtual {v2}, Lcom/ironsource/y7;->c()Ljava/lang/String;
    ...
    check-cast v3, Lcom/ironsource/y7;

    new-instance v11, Lcom/ironsource/c8;

    invoke-virtual {v3}, Lcom/ironsource/y7;->d()I

    move-result v5

    invoke-virtual {v3}, Lcom/ironsource/y7;->c()Ljava/lang/String;
    ...
    invoke-direct/range {v4 .. v10}, Lcom/ironsource/c8;-><init>(ILjava/lang/String;Ljava/util/Map;JLjava/lang/String;)V
    ...
    :cond_3
    iget-object p1, p0, Lcom/ironsource/b8$a;->b:Lcom/ironsource/b8;

    invoke-static {p1, v1, v0, p2, p3}, Lcom/ironsource/b8;->a(Lcom/ironsource/b8;Ljava/util/List;Ljava/util/List;J)V

    iget-object p1, p0, Lcom/ironsource/b8$a;->a:Lcom/ironsource/b8$b;

    invoke-interface {p1, v1, p2, p3, v0}, Lcom/ironsource/b8$b;->a(Ljava/util/List;JLjava/util/List;)V
...
.method public onWorkFailed(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/ironsource/b8$a;->a:Lcom/ironsource/b8$b;

    invoke-interface {v0, p1}, Lcom/ironsource/b8$b;->onFailure(Ljava/lang/String;)V
