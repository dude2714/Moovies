...
# direct methods
.method constructor <init>(Lcom/ironsource/fg;Lcom/ironsource/eg;Lcom/ironsource/t0;Lcom/ironsource/xk;Lcom/ironsource/mediationsdk/IronSourceSegment;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lcom/ironsource/p7;-><init>(Lcom/ironsource/fg;Lcom/ironsource/eg;Lcom/ironsource/t0;Lcom/ironsource/xk;Lcom/ironsource/mediationsdk/IronSourceSegment;)V

    return-void
.end method

.method protected constructor <init>(Lcom/ironsource/t0;Lcom/ironsource/xk;Lcom/ironsource/mediationsdk/IronSourceSegment;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/ironsource/p7;-><init>(Lcom/ironsource/t0;Lcom/ironsource/xk;Lcom/ironsource/mediationsdk/IronSourceSegment;)V
...
.method private a(Ljava/util/List;)Ljava/lang/String;
    ...
    check-cast v1, Lcom/ironsource/o7;

    invoke-virtual {v1}, Lcom/ironsource/s7;->e()Ljava/lang/Long;
...
.method private a(Landroid/app/Activity;Lcom/ironsource/o7;Lcom/ironsource/mediationsdk/model/Placement;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    invoke-virtual {p2, p1, p3}, Lcom/ironsource/o7;->a(Landroid/app/Activity;Lcom/ironsource/mediationsdk/model/Placement;)V

    return-void
.end method

.method private a(Lcom/ironsource/mediationsdk/logger/IronSourceError;Lcom/ironsource/o7;Ljava/lang/String;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p3, p0, Lcom/ironsource/p7;->q:Lcom/ironsource/o2;

    invoke-virtual {p3}, Lcom/ironsource/o2;->g()V

    if-eqz p2, :cond_0

    invoke-virtual {p2}, Lcom/ironsource/s7;->f()Lcom/ironsource/mediationsdk/adunit/adapter/utility/AdInfo;
...
.method private a(Lcom/ironsource/mediationsdk/logger/IronSourceError;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0, p2}, Lcom/ironsource/n7;->a(Lcom/ironsource/mediationsdk/logger/IronSourceError;Lcom/ironsource/o7;Ljava/lang/String;)V

    return-void
.end method

.method static synthetic a(Lcom/ironsource/n7;Landroid/app/Activity;Lcom/ironsource/mediationsdk/model/Placement;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/ironsource/n7;->b(Landroid/app/Activity;Lcom/ironsource/mediationsdk/model/Placement;)V

    return-void
.end method

.method private a(Lcom/ironsource/o7;Ljava/util/List;)V
    .locals 3
    .param p1    # Lcom/ironsource/o7;
    ...
    invoke-virtual {p1, p2}, Lcom/ironsource/o7;->b(Z)V
    ...
    invoke-virtual {v0, v1}, Lcom/ironsource/o7;->b(Z)V
    ...
    invoke-virtual {v0}, Lcom/ironsource/s7;->k()Ljava/lang/String;
...
.method private b(Landroid/app/Activity;Lcom/ironsource/mediationsdk/model/Placement;)V
    ...
    sget-object v2, Lcom/ironsource/p7$f;->f:Lcom/ironsource/p7$f;
    ...
    invoke-static {v4}, Lcom/ironsource/y1;->g(Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;)I
    ...
    :cond_0
    sget-object v4, Lcom/ironsource/p7$f;->e:Lcom/ironsource/p7$f;
    ...
    invoke-static {v4}, Lcom/ironsource/y1;->b(Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;)I
    ...
    invoke-interface {v1, v4, p2, v5}, Lcom/ironsource/jg;->b(Landroid/content/Context;Lcom/ironsource/mediationsdk/model/BasePlacement;Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;)Z
    ...
    invoke-static {v4}, Lcom/ironsource/y1;->f(Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;)I
    ...
    :goto_1
    invoke-direct {p0, v1, p2}, Lcom/ironsource/n7;->a(Lcom/ironsource/mediationsdk/logger/IronSourceError;Ljava/lang/String;)V
    ...
    invoke-virtual {p2}, Lcom/ironsource/kx;->b()Ljava/util/List;
    ...
    invoke-direct {v1, v3}, Lcom/ironsource/px;-><init>(Lcom/ironsource/t0;)V

    invoke-virtual {v1, p2}, Lcom/ironsource/px;->c(Ljava/util/List;)Lcom/ironsource/s7;

    move-result-object v3

    check-cast v3, Lcom/ironsource/o7;

    invoke-virtual {v1, p2}, Lcom/ironsource/px;->b(Ljava/util/List;)Ljava/util/List;

    move-result-object v1

    invoke-direct {p0, v3, v1}, Lcom/ironsource/n7;->a(Lcom/ironsource/o7;Ljava/util/List;)V

    if-eqz v3, :cond_5

    invoke-virtual {p0, v2}, Lcom/ironsource/p7;->a(Lcom/ironsource/p7$f;)V

    invoke-virtual {p0, v3}, Lcom/ironsource/p7;->i(Lcom/ironsource/s7;)V
    ...
    invoke-direct {p0, p2}, Lcom/ironsource/n7;->a(Ljava/util/List;)Ljava/lang/String;
    ...
    iget-object p2, p0, Lcom/ironsource/p7;->i:Lcom/ironsource/mediationsdk/model/Placement;

    invoke-direct {p0, p1, v3, p2}, Lcom/ironsource/n7;->a(Landroid/app/Activity;Lcom/ironsource/o7;Lcom/ironsource/mediationsdk/model/Placement;)V
...
.method public a(Landroid/app/Activity;Lcom/ironsource/mediationsdk/model/Placement;)V
    ...
    invoke-direct {v0, p0, p1, p2}, Lcom/ironsource/n7$a;-><init>(Lcom/ironsource/n7;Landroid/app/Activity;Lcom/ironsource/mediationsdk/model/Placement;)V
...
.method public a(Lcom/ironsource/mediationsdk/logger/IronSourceError;Lcom/ironsource/o7;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/ironsource/n7;->a(Lcom/ironsource/mediationsdk/logger/IronSourceError;Lcom/ironsource/o7;Ljava/lang/String;)V
...
.method public a(Lcom/ironsource/o7;)V
    ...
    iget-object v0, p0, Lcom/ironsource/p7;->p:Lcom/ironsource/p7$f;
...
.method public c(Lcom/ironsource/o7;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public d()Ljava/lang/String;
    ...
    check-cast v2, Lcom/ironsource/o7;

    invoke-virtual {v2}, Lcom/ironsource/s7;->y()Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-virtual {v2}, Lcom/ironsource/s7;->c()Ljava/lang/String;
...
.method public d(Lcom/ironsource/o7;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public u()Z
    ...
    invoke-virtual {v2}, Lcom/ironsource/o7;->B()Z
