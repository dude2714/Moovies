...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/google/firebase/analytics/FirebaseAnalytics$ʿ;,
        Lcom/google/firebase/analytics/FirebaseAnalytics$ʾ;,
        Lcom/google/firebase/analytics/FirebaseAnalytics$ʽ;
    }
.end annotation


# static fields
.field private static volatile ʻ:Lcom/google/firebase/analytics/FirebaseAnalytics;


# instance fields
.field private final ʼ:Lcom/google/android/gms/internal/measurement/zzee;
...
.method public constructor <init>(Lcom/google/android/gms/internal/measurement/zzee;)V
    ...
    iput-object p1, p0, Lcom/google/firebase/analytics/FirebaseAnalytics;->ʼ:Lcom/google/android/gms/internal/measurement/zzee;
...
.method public static getInstance(Landroid/content/Context;)Lcom/google/firebase/analytics/FirebaseAnalytics;
    ...
    sget-object v0, Lcom/google/firebase/analytics/FirebaseAnalytics;->ʻ:Lcom/google/firebase/analytics/FirebaseAnalytics;
    ...
    :try_start_0
    sget-object v1, Lcom/google/firebase/analytics/FirebaseAnalytics;->ʻ:Lcom/google/firebase/analytics/FirebaseAnalytics;
    ...
    sput-object v1, Lcom/google/firebase/analytics/FirebaseAnalytics;->ʻ:Lcom/google/firebase/analytics/FirebaseAnalytics;
    ...
    :cond_1
    :goto_0
    sget-object p0, Lcom/google/firebase/analytics/FirebaseAnalytics;->ʻ:Lcom/google/firebase/analytics/FirebaseAnalytics;
...
.method public static getScionFrontendApiImplementation(Landroid/content/Context;Landroid/os/Bundle;)Lcom/google/android/gms/measurement/internal/zzie;
    ...
    :cond_0
    new-instance p1, Lcom/google/firebase/analytics/ʽ;

    invoke-direct {p1, p0}, Lcom/google/firebase/analytics/ʽ;-><init>(Lcom/google/android/gms/internal/measurement/zzee;)V

    return-object p1
.end method

.method static bridge synthetic ˋ(Lcom/google/firebase/analytics/FirebaseAnalytics;)Lcom/google/android/gms/internal/measurement/zzee;
    .locals 0

    iget-object p0, p0, Lcom/google/firebase/analytics/FirebaseAnalytics;->ʼ:Lcom/google/android/gms/internal/measurement/zzee;
...
.method public getFirebaseInstanceId()Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {}, Lcom/google/firebase/installations/ˋ;->ـ()Lcom/google/firebase/installations/ˋ;

    move-result-object v0

    invoke-virtual {v0}, Lcom/google/firebase/installations/ˋ;->getId()Lcom/google/android/gms/tasks/Task;
...
.method public setCurrentScreen(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/google/firebase/analytics/FirebaseAnalytics;->ʼ:Lcom/google/android/gms/internal/measurement/zzee;
...
.method public ʻ()Lcom/google/android/gms/tasks/Task;
    ...
    :try_start_1
    iget-object v1, p0, Lcom/google/firebase/analytics/FirebaseAnalytics;->ʽ:Ljava/util/concurrent/ExecutorService;

    if-nez v1, :cond_0

    new-instance v1, Lcom/google/firebase/analytics/ʻ;
    ...
    invoke-direct/range {v2 .. v9}, Lcom/google/firebase/analytics/ʻ;-><init>(Lcom/google/firebase/analytics/FirebaseAnalytics;IIJLjava/util/concurrent/TimeUnit;Ljava/util/concurrent/BlockingQueue;)V

    iput-object v1, p0, Lcom/google/firebase/analytics/FirebaseAnalytics;->ʽ:Ljava/util/concurrent/ExecutorService;
    ...
    :try_start_2
    new-instance v0, Lcom/google/firebase/analytics/ʼ;

    invoke-direct {v0, p0}, Lcom/google/firebase/analytics/ʼ;-><init>(Lcom/google/firebase/analytics/FirebaseAnalytics;)V
    ...
    iget-object v1, p0, Lcom/google/firebase/analytics/FirebaseAnalytics;->ʼ:Lcom/google/android/gms/internal/measurement/zzee;
...
.method public ʿ(Ljava/util/Map;)V
    .locals 6
    ...
    sget-object v1, Lcom/google/firebase/analytics/FirebaseAnalytics$ʼ;->ʽʽ:Lcom/google/firebase/analytics/FirebaseAnalytics$ʼ;

    invoke-interface {p1, v1}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lcom/google/firebase/analytics/FirebaseAnalytics$ʻ;
    ...
    :cond_2
    :goto_0
    sget-object v1, Lcom/google/firebase/analytics/FirebaseAnalytics$ʼ;->ʼʼ:Lcom/google/firebase/analytics/FirebaseAnalytics$ʼ;

    invoke-interface {p1, v1}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lcom/google/firebase/analytics/FirebaseAnalytics$ʻ;
    ...
    :cond_5
    :goto_1
    iget-object p1, p0, Lcom/google/firebase/analytics/FirebaseAnalytics;->ʼ:Lcom/google/android/gms/internal/measurement/zzee;
