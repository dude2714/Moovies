...
# static fields
.field private static final ʻ:Ljava/lang/String; = "Could not load Finalizer in its own class loader. Loading Finalizer in the current class loader instead. As a result, you will not be able to garbage collect this class loader. To support reclaiming this class loader, either resolve the underlying issue, or move Guava to your system class path."
...
.method public ʻ()Ljava/lang/Class;
    ...
    :try_start_0
    invoke-virtual {p0}, Lst0$ʻ;->ʼ()Ljava/net/URL;

    move-result-object v0

    invoke-virtual {p0, v0}, Lst0$ʻ;->ʽ(Ljava/net/URL;)Ljava/net/URLClassLoader;
...
.method ʽ(Ljava/net/URL;)Ljava/net/URLClassLoader;
    .locals 3
