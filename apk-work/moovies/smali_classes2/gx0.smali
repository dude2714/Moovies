...
# instance fields
.field private final transient ʾʾ:Ljava/util/concurrent/ConcurrentMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method constructor <init>(Ljava/util/concurrent/ConcurrentMap;)V
    ...
    iput-object p1, p0, Lgx0;->ʾʾ:Ljava/util/concurrent/ConcurrentMap;

    return-void
.end method

.method static synthetic ˆ(Lgx0;)Ljava/util/concurrent/ConcurrentMap;
    .locals 0

    iget-object p0, p0, Lgx0;->ʾʾ:Ljava/util/concurrent/ConcurrentMap;

    return-object p0
.end method

.method public static ˉ()Lgx0;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    invoke-direct {v0, v1}, Lgx0;-><init>(Ljava/util/concurrent/ConcurrentMap;)V

    return-object v0
.end method

.method public static ˊ(Ljava/lang/Iterable;)Lgx0;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
...
.method public static ˎ(Ljava/util/concurrent/ConcurrentMap;)Lgx0;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    invoke-direct {v0, p0}, Lgx0;-><init>(Ljava/util/concurrent/ConcurrentMap;)V

    return-object v0
.end method

.method private ˏ(Ljava/io/ObjectInputStream;)V
    .locals 1
    ...
    sget-object v0, Lgx0$ʿ;->ʻ:Lp21$ʼ;
...
.method private י()Ljava/util/List;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {p0}, Lgx0;->entrySet()Ljava/util/Set;
...
.method private ـ(Ljava/io/ObjectOutputStream;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v0, p0, Lgx0;->ʾʾ:Ljava/util/concurrent/ConcurrentMap;
...
.method public remove(Ljava/lang/Object;I)I
    ...
    invoke-virtual {p0, p1}, Lgx0;->ʼـ(Ljava/lang/Object;)I
    ...
    invoke-static {v0, p1}, Lg11;->ʻᵎ(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object p2, p0, Lgx0;->ʾʾ:Ljava/util/concurrent/ConcurrentMap;
...
.method public toArray()[Ljava/lang/Object;
    ...
    invoke-direct {p0}, Lgx0;->י()Ljava/util/List;
...
.method ʻ()Ljava/util/Set;
    ...
    new-instance v1, Lgx0$ʻ;

    invoke-direct {v1, p0, v0}, Lgx0$ʻ;-><init>(Lgx0;Ljava/util/Set;)V
...
.method public ʼ()Ljava/util/Set;
    ...
    new-instance v0, Lgx0$ʾ;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lgx0$ʾ;-><init>(Lgx0;Lgx0$ʻ;)V
...
.method public ʼˎ(Ljava/lang/Object;II)Z
    ...
    iget-object p3, p0, Lgx0;->ʾʾ:Ljava/util/concurrent/ConcurrentMap;
...
.method ʿ()Ljava/util/Iterator;
    ...
    new-instance v0, Lgx0$ʼ;

    invoke-direct {v0, p0}, Lgx0$ʼ;-><init>(Lgx0;)V

    new-instance v1, Lgx0$ʽ;

    invoke-direct {v1, p0, v0}, Lgx0$ʽ;-><init>(Lgx0;Ljava/util/Iterator;)V
...
.method public ˎˎ(Ljava/lang/Object;I)I
    ...
    iget-object v3, p0, Lgx0;->ʾʾ:Ljava/util/concurrent/ConcurrentMap;
...
.method public ˑ(Ljava/lang/Object;I)Z
    .locals 5
    .param p1    # Ljava/lang/Object;
        .annotation runtime Lorg/checkerframework/checker/nullness/compatqual/NullableDecl;
        .end annotation
    ...
    invoke-static {p2, v1}, Lvw0;->ʾ(ILjava/lang/String;)V

    iget-object v1, p0, Lgx0;->ʾʾ:Ljava/util/concurrent/ConcurrentMap;
...
.method public ᵢᵢ(Ljava/lang/Object;I)I
    ...
    :try_start_0
    invoke-static {v2, p2}, Le91;->ʽ(II)I
