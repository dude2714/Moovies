...
.field final synthetic ʿ:Lkd4$ʼ;
...
.method public constructor <init>(Lkd4$ʼ;Ljava/io/File;)V
    ...
    iput-object p1, p0, Lkd4$ʼ$ʽ;->ʿ:Lkd4$ʼ;
...
.method public ʼ()Ljava/io/File;
    ...
    iget-boolean v0, p0, Lkd4$ʼ$ʽ;->ʼ:Z

    const/4 v1, 0x0

    if-nez v0, :cond_2

    iget-object v0, p0, Lkd4$ʼ$ʽ;->ʿ:Lkd4$ʼ;
    ...
    :cond_1
    iput-boolean v3, p0, Lkd4$ʼ$ʽ;->ʼ:Z
    ...
    :cond_2
    iget-object v0, p0, Lkd4$ʼ$ʽ;->ʽ:[Ljava/io/File;

    if-eqz v0, :cond_5

    iget v2, p0, Lkd4$ʼ$ʽ;->ʾ:I
    ...
    iput-object v0, p0, Lkd4$ʼ$ʽ;->ʽ:[Ljava/io/File;
    ...
    invoke-direct/range {v3 .. v8}, Lad4;-><init>(Ljava/io/File;Ljava/io/File;Ljava/lang/String;ILuh4;)V

    invoke-interface {v0, v2, v9}, Lpg4;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget v1, p0, Lkd4$ʼ$ʽ;->ʾ:I

    add-int/lit8 v2, v1, 0x1

    iput v2, p0, Lkd4$ʼ$ʽ;->ʾ:I
