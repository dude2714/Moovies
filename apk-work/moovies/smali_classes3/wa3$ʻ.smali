...
.field final ˆˆ:Ljava/util/Iterator;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Iterator<",
            "+",
...
# direct methods
.method constructor <init>(Ldr5;Ljava/util/Iterator;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lwa3$ʻ;->ʼʼ:Ldr5;

    iput-object p2, p0, Lwa3$ʻ;->ˆˆ:Ljava/util/Iterator;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicLong;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicLong;-><init>()V

    iput-object p1, p0, Lwa3$ʻ;->ʿʿ:Ljava/util/concurrent/atomic/AtomicLong;

    new-instance p1, Lc13;

    invoke-direct {p1}, Lc13;-><init>()V

    iput-object p1, p0, Lwa3$ʻ;->ــ:Lc13;
    ...
    iput-object p1, p0, Lwa3$ʻ;->ʾʾ:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public cancel()V
    ...
    iget-object v0, p0, Lwa3$ʻ;->ــ:Lc13;
...
.method public onComplete()V
    ...
    iget-object v0, p0, Lwa3$ʻ;->ʾʾ:Ljava/util/concurrent/atomic/AtomicReference;

    sget-object v1, Lcp3;->ʽʽ:Lcp3;

    invoke-virtual {v0, v1}, Ljava/util/concurrent/atomic/AtomicReference;->lazySet(Ljava/lang/Object;)V

    invoke-virtual {p0}, Lwa3$ʻ;->ʻ()V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Lwa3$ʻ;->ʼʼ:Ldr5;
...
.method public request(J)V
    ...
    iget-object v0, p0, Lwa3$ʻ;->ʿʿ:Ljava/util/concurrent/atomic/AtomicLong;
...
.method ʻ()V
    ...
    iget-object v1, p0, Lwa3$ʻ;->ʼʼ:Ldr5;

    iget-object v2, p0, Lwa3$ʻ;->ــ:Lc13;
    ...
    iget-wide v7, p0, Lwa3$ʻ;->ˉˉ:J

    iget-object v5, p0, Lwa3$ʻ;->ʿʿ:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    :try_start_0
    iget-object v3, p0, Lwa3$ʻ;->ˆˆ:Ljava/util/Iterator;
