...
.method public constructor <init>(Ljava/util/concurrent/Callable;Lr03;Lj03;Z)V
    ...
    iput-object p1, p0, Lm43;->ʽʽ:Ljava/util/concurrent/Callable;

    iput-object p2, p0, Lm43;->ʼʼ:Lr03;

    iput-object p3, p0, Lm43;->ʿʿ:Lj03;

    iput-boolean p4, p0, Lm43;->ʾʾ:Z
...
.method protected ʼـ(Lmx2;)V
    ...
    :try_start_0
    iget-object v0, p0, Lm43;->ʽʽ:Ljava/util/concurrent/Callable;
    ...
    :try_start_1
    iget-object v1, p0, Lm43;->ʼʼ:Lr03;
    ...
    new-instance v2, Lm43$ʻ;

    iget-object v3, p0, Lm43;->ʿʿ:Lj03;

    iget-boolean v4, p0, Lm43;->ʾʾ:Z

    invoke-direct {v2, p1, v0, v3, v4}, Lm43$ʻ;-><init>(Lmx2;Ljava/lang/Object;Lj03;Z)V

    invoke-interface {v1, v2}, Lpx2;->ʻ(Lmx2;)V
    ...
    iget-boolean v2, p0, Lm43;->ʾʾ:Z

    if-eqz v2, :cond_0

    :try_start_2
    iget-object v2, p0, Lm43;->ʿʿ:Lj03;
    ...
    invoke-static {v2, p1}, Lz03;->ˆ(Ljava/lang/Throwable;Lmx2;)V

    return-void

    :cond_0
    :goto_0
    invoke-static {v1, p1}, Lz03;->ˆ(Ljava/lang/Throwable;Lmx2;)V

    iget-boolean p1, p0, Lm43;->ʾʾ:Z

    if-nez p1, :cond_1

    :try_start_3
    iget-object p1, p0, Lm43;->ʿʿ:Lj03;
