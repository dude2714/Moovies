...
.field private ˈ:Lws2;

.field private ˉ:Ljava/nio/charset/CodingErrorAction;

.field private ˊ:Ljava/nio/charset/CodingErrorAction;

.field private ˋ:Ljava/nio/charset/CharsetEncoder;
...
.method protected constructor <init>(Ljava/io/OutputStream;ILjava/nio/charset/Charset;ILjava/nio/charset/CodingErrorAction;Ljava/nio/charset/CodingErrorAction;)V
    ...
    iput-object p1, p0, Lfs2;->ʼ:Ljava/io/OutputStream;

    new-instance p1, Luw2;

    invoke-direct {p1, p2}, Luw2;-><init>(I)V

    iput-object p1, p0, Lfs2;->ʽ:Luw2;
    ...
    :cond_0
    sget-object p3, Ls72;->ˆ:Ljava/nio/charset/Charset;

    :goto_0
    iput-object p3, p0, Lfs2;->ʾ:Ljava/nio/charset/Charset;
    ...
    iput-boolean p1, p0, Lfs2;->ʿ:Z

    const/4 p1, 0x0

    iput-object p1, p0, Lfs2;->ˋ:Ljava/nio/charset/CharsetEncoder;
    ...
    invoke-virtual {p0}, Lfs2;->ʾ()Lws2;

    move-result-object p1

    iput-object p1, p0, Lfs2;->ˈ:Lws2;
    ...
    :goto_2
    iput-object p5, p0, Lfs2;->ˉ:Ljava/nio/charset/CodingErrorAction;
    ...
    :goto_3
    iput-object p6, p0, Lfs2;->ˊ:Ljava/nio/charset/CodingErrorAction;

    return-void
.end method

.method private ˆ(Ljava/nio/charset/CoderResult;)V
    .locals 1
    ...
    :cond_0
    iget-object p1, p0, Lfs2;->ˎ:Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p0, p1}, Lfs2;->write(I)V
...
.method private ˊ(Ljava/nio/CharBuffer;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    iget-object v0, p0, Lfs2;->ˋ:Ljava/nio/charset/CharsetEncoder;

    if-nez v0, :cond_1

    iget-object v0, p0, Lfs2;->ʾ:Ljava/nio/charset/Charset;

    invoke-virtual {v0}, Ljava/nio/charset/Charset;->newEncoder()Ljava/nio/charset/CharsetEncoder;

    move-result-object v0

    iput-object v0, p0, Lfs2;->ˋ:Ljava/nio/charset/CharsetEncoder;

    iget-object v1, p0, Lfs2;->ˉ:Ljava/nio/charset/CodingErrorAction;

    invoke-virtual {v0, v1}, Ljava/nio/charset/CharsetEncoder;->onMalformedInput(Ljava/nio/charset/CodingErrorAction;)Ljava/nio/charset/CharsetEncoder;

    iget-object v0, p0, Lfs2;->ˋ:Ljava/nio/charset/CharsetEncoder;

    iget-object v1, p0, Lfs2;->ˊ:Ljava/nio/charset/CodingErrorAction;

    invoke-virtual {v0, v1}, Ljava/nio/charset/CharsetEncoder;->onUnmappableCharacter(Ljava/nio/charset/CodingErrorAction;)Ljava/nio/charset/CharsetEncoder;

    :cond_1
    iget-object v0, p0, Lfs2;->ˎ:Ljava/nio/ByteBuffer;
    ...
    iput-object v0, p0, Lfs2;->ˎ:Ljava/nio/ByteBuffer;
    ...
    iget-object v1, p0, Lfs2;->ˎ:Ljava/nio/ByteBuffer;
    ...
    invoke-direct {p0, v0}, Lfs2;->ˆ(Ljava/nio/charset/CoderResult;)V

    goto :goto_0

    :cond_3
    iget-object p1, p0, Lfs2;->ˋ:Ljava/nio/charset/CharsetEncoder;
    ...
    invoke-direct {p0, p1}, Lfs2;->ˆ(Ljava/nio/charset/CoderResult;)V
...
.method public available()I
    ...
    invoke-virtual {p0}, Lfs2;->ʽ()I

    move-result v0

    invoke-virtual {p0}, Lfs2;->length()I
...
.method public flush()V
    ...
    invoke-virtual {p0}, Lfs2;->ʿ()V

    iget-object v0, p0, Lfs2;->ʼ:Ljava/io/OutputStream;
...
.method public write([B)V
    ...
    invoke-virtual {p0, p1, v0, v1}, Lfs2;->write([BII)V
...
.method public ʻ(Lvw2;)V
    ...
    iget-object v2, p0, Lfs2;->ʽ:Luw2;

    invoke-virtual {v2}, Luw2;->ˉ()I

    move-result v2

    iget-object v3, p0, Lfs2;->ʽ:Luw2;
    ...
    invoke-direct {p0, p1}, Lfs2;->ˊ(Ljava/nio/CharBuffer;)V

    :cond_4
    sget-object p1, Lfs2;->ʻ:[B

    invoke-virtual {p0, p1}, Lfs2;->write([B)V
...
.method public ʼ(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lfs2;->write(I)V
...
.method protected ʿ()V
    ...
    iget-object v1, p0, Lfs2;->ʼ:Ljava/io/OutputStream;

    iget-object v2, p0, Lfs2;->ʽ:Luw2;

    invoke-virtual {v2}, Luw2;->ʿ()[B
...
.method protected ˈ(Ljava/io/OutputStream;ILwu2;)V
    .locals 1
    ...
    :goto_0
    iput-object p1, p0, Lfs2;->ʾ:Ljava/nio/charset/Charset;
    ...
    :goto_1
    iput-object p1, p0, Lfs2;->ˉ:Ljava/nio/charset/CodingErrorAction;
    ...
    :goto_2
    iput-object p1, p0, Lfs2;->ˊ:Ljava/nio/charset/CodingErrorAction;
