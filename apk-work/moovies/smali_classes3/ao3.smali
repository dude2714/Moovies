...
# static fields
.field private static final ʽʽ:J = -0x44a0454d820bd1c8L
...
.method public constructor <init>(Ldr5;)V
    ...
    iput-object p1, p0, Lao3;->ʼʼ:Ldr5;

    new-instance p1, Loo3;

    invoke-direct {p1}, Loo3;-><init>()V

    iput-object p1, p0, Lao3;->ʿʿ:Loo3;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicLong;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicLong;-><init>()V

    iput-object p1, p0, Lao3;->ʾʾ:Ljava/util/concurrent/atomic/AtomicLong;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    iput-object p1, p0, Lao3;->ــ:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    iput-object p1, p0, Lao3;->ˆˆ:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public cancel()V
    ...
    iget-boolean v0, p0, Lao3;->ˉˉ:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lao3;->ــ:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public onComplete()V
    ...
    iput-boolean v0, p0, Lao3;->ˉˉ:Z

    iget-object v0, p0, Lao3;->ʼʼ:Ldr5;

    iget-object v1, p0, Lao3;->ʿʿ:Loo3;
...
.method public request(J)V
    ...
    invoke-virtual {p0}, Lao3;->cancel()V
    ...
    invoke-virtual {p0, v0}, Lao3;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v1, p0, Lao3;->ʾʾ:Ljava/util/concurrent/atomic/AtomicLong;
...
.method public ˆ(Ler5;)V
    ...
    iget-object v0, p0, Lao3;->ˆˆ:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {p0, p1}, Lao3;->onError(Ljava/lang/Throwable;)V
