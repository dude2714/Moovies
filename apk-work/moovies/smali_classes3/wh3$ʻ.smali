...
.method constructor <init>(Lpy2;Lar3;Lny2;)V
    ...
    iput-object p1, p0, Lwh3$ʻ;->ʼʼ:Lpy2;

    iput-object p2, p0, Lwh3$ʻ;->ــ:Lar3;

    iput-object p3, p0, Lwh3$ʻ;->ˈˈ:Lny2;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>()V

    iput-object p1, p0, Lwh3$ʻ;->ʿʿ:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Loo3;

    invoke-direct {p1}, Loo3;-><init>()V

    iput-object p1, p0, Lwh3$ʻ;->ʾʾ:Loo3;

    new-instance p1, Lwh3$ʻ$ʻ;

    invoke-direct {p1, p0}, Lwh3$ʻ$ʻ;-><init>(Lwh3$ʻ;)V

    iput-object p1, p0, Lwh3$ʻ;->ˆˆ:Lwh3$ʻ$ʻ;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    iput-object p1, p0, Lwh3$ʻ;->ˉˉ:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public onComplete()V
    ...
    iget-object v0, p0, Lwh3$ʻ;->ˉˉ:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-boolean v0, p0, Lwh3$ʻ;->ˋˋ:Z

    iget-object v1, p0, Lwh3$ʻ;->ــ:Lar3;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Lwh3$ʻ;->ˆˆ:Lwh3$ʻ$ʻ;

    invoke-static {v0}, Ly03;->ʻ(Ljava/util/concurrent/atomic/AtomicReference;)Z

    iget-object v0, p0, Lwh3$ʻ;->ʼʼ:Lpy2;

    iget-object v1, p0, Lwh3$ʻ;->ʾʾ:Loo3;
...
.method ˆ()V
    ...
    iget-object v0, p0, Lwh3$ʻ;->ʿʿ:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_1
    iget-boolean v0, p0, Lwh3$ʻ;->ˋˋ:Z
    ...
    iget-object v0, p0, Lwh3$ʻ;->ˈˈ:Lny2;
