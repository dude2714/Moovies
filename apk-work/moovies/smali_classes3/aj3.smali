...
.method public constructor <init>(Lny2;JLjava/util/concurrent/TimeUnit;Lqy2;)V
    ...
    iput-wide p2, p0, Laj3;->ʼʼ:J

    iput-object p4, p0, Laj3;->ʿʿ:Ljava/util/concurrent/TimeUnit;

    iput-object p5, p0, Laj3;->ʾʾ:Lqy2;
...
.method public ˑˋ(Lpy2;)V
    ...
    new-instance v7, Laj3$ʻ;

    new-instance v2, Lzp3;

    invoke-direct {v2, p1}, Lzp3;-><init>(Lpy2;)V

    iget-wide v3, p0, Laj3;->ʼʼ:J

    iget-object v5, p0, Laj3;->ʿʿ:Ljava/util/concurrent/TimeUnit;

    iget-object p1, p0, Laj3;->ʾʾ:Lqy2;
    ...
    invoke-direct/range {v1 .. v6}, Laj3$ʻ;-><init>(Lpy2;JLjava/util/concurrent/TimeUnit;Lqy2$ʽ;)V
