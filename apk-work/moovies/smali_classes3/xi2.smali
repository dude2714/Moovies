...
.method public static ʻ(Ljava/lang/String;I)[B
    ...
    invoke-static {p0, p1}, Lxi2;->ʼ([BI)[B
...
.method public static ʼ([BI)[B
    ...
    invoke-static {p0, v1, v0, p1}, Lxi2;->ʽ([BIII)[B
...
.method public static ʽ([BIII)[B
    ...
    invoke-direct {v0, p3, v1}, Lxi2$ʼ;-><init>(I[B)V

    const/4 p3, 0x1

    invoke-virtual {v0, p0, p1, p2, p3}, Lxi2$ʼ;->ʼ([BIIZ)Z

    move-result p0

    if-eqz p0, :cond_1

    iget p0, v0, Lxi2$ʻ;->ʼ:I

    iget-object p1, v0, Lxi2$ʻ;->ʻ:[B
...
.method public static ʾ([BI)[B
    ...
    invoke-static {p0, v1, v0, p1}, Lxi2;->ʿ([BIII)[B
...
.method public static ʿ([BIII)[B
    ...
    new-instance v0, Lxi2$ʽ;

    const/4 v1, 0x0

    invoke-direct {v0, p3, v1}, Lxi2$ʽ;-><init>(I[B)V
    ...
    iput-object p3, v0, Lxi2$ʻ;->ʻ:[B

    invoke-virtual {v0, p0, p1, p2, v3}, Lxi2$ʽ;->ʼ([BIIZ)Z

    iget-object p0, v0, Lxi2$ʻ;->ʻ:[B
...
.method public static ˈ([BIII)Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2, p3}, Lxi2;->ʿ([BIII)[B
