...
.method public constructor <init>(Lny2;Lr03;)V
    ...
    iput-object p2, p0, Lwh3;->ʼʼ:Lr03;
...
.method protected ˑˋ(Lpy2;)V
    ...
    :try_start_0
    iget-object v1, p0, Lwh3;->ʼʼ:Lr03;
    ...
    new-instance v2, Lwh3$ʻ;

    iget-object v3, p0, Lee3;->ʽʽ:Lny2;

    invoke-direct {v2, p1, v0, v3}, Lwh3$ʻ;-><init>(Lpy2;Lar3;Lny2;)V

    invoke-interface {p1, v2}, Lpy2;->ʿ(Loz2;)V

    iget-object p1, v2, Lwh3$ʻ;->ˆˆ:Lwh3$ʻ$ʻ;

    invoke-interface {v1, p1}, Lny2;->ʾ(Lpy2;)V

    invoke-virtual {v2}, Lwh3$ʻ;->ˆ()V
