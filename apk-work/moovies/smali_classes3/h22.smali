...
# static fields
.field private static final ʻ:Ljava/lang/String; = "CameraConfiguration"

.field private static final ʼ:Ljava/util/regex/Pattern;

.field private static final ʽ:F = 1.5f

.field private static final ʾ:F = 0.0f

.field private static final ʿ:I = 0xa

.field private static final ˆ:I = 0x14

.field private static final ˈ:I = 0x190
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lh22;->ʼ:Ljava/util/regex/Pattern;
...
.method private static ʻ(I)Ljava/util/List;
    .locals 3
...
.method public static ʼ(Landroid/hardware/Camera$Parameters;)Ljava/lang/String;
    .locals 0
    ...
    invoke-static {p0}, Lh22;->ʽ(Ljava/lang/CharSequence;)Ljava/lang/String;
...
.method public static ʽ(Ljava/lang/CharSequence;)Ljava/lang/String;
    .locals 5
    ...
    sget-object v2, Lh22;->ʼ:Ljava/util/regex/Pattern;
...
.method private static varargs ʾ(Ljava/lang/String;Ljava/util/Collection;[Ljava/lang/String;)Ljava/lang/String;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static ʿ(Landroid/hardware/Camera$Parameters;D)Ljava/lang/Integer;
    .locals 10
...
.method public static ˆ(Landroid/hardware/Camera$Parameters;)V
    .locals 3
    ...
    invoke-static {v2, v0, v1}, Lh22;->ʾ(Ljava/lang/String;Ljava/util/Collection;[Ljava/lang/String;)Ljava/lang/String;
...
.method public static ˈ(Landroid/hardware/Camera$Parameters;Z)V
    .locals 6
...
.method public static ˉ(Landroid/hardware/Camera$Parameters;)V
    .locals 2
    ...
    invoke-static {p0, v0, v1}, Lh22;->ˊ(Landroid/hardware/Camera$Parameters;II)V

    return-void
.end method

.method public static ˊ(Landroid/hardware/Camera$Parameters;II)V
    .locals 9
    ...
    invoke-static {v0}, Lh22;->ᴵ(Ljava/util/Collection;)Ljava/lang/String;
...
.method public static ˋ(Landroid/hardware/Camera$Parameters;Ll22$ʻ;Z)V
    .locals 5
    ...
    sget-object v4, Ll22$ʻ;->ʽʽ:Ll22$ʻ;
    ...
    :cond_0
    sget-object v4, Ll22$ʻ;->ʼʼ:Ll22$ʻ;
    ...
    invoke-static {v3, v0, p1}, Lh22;->ʾ(Ljava/lang/String;Ljava/util/Collection;[Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    sget-object v2, Ll22$ʻ;->ʿʿ:Ll22$ʻ;
    ...
    :cond_2
    sget-object v2, Ll22$ʻ;->ʾʾ:Ll22$ʻ;
...
.method public static ˎ(Landroid/hardware/Camera$Parameters;)V
    .locals 4
    .annotation build Landroid/annotation/TargetApi;
        value = 0xf
    .end annotation
    ...
    invoke-static {v2}, Lh22;->ᐧ(Ljava/lang/Iterable;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lh22;->ʻ(I)Ljava/util/List;
    ...
    invoke-static {v0}, Lh22;->ᐧ(Ljava/lang/Iterable;)Ljava/lang/String;
...
.method public static ˏ(Landroid/hardware/Camera$Parameters;)V
    .locals 3
...
.method public static ˑ(Landroid/hardware/Camera$Parameters;)V
    .locals 4
    .annotation build Landroid/annotation/TargetApi;
        value = 0xf
    .end annotation
...
.method public static י(Landroid/hardware/Camera$Parameters;Z)V
    .locals 3
    ...
    invoke-static {v1, v0, p1}, Lh22;->ʾ(Ljava/lang/String;Ljava/util/Collection;[Ljava/lang/String;)Ljava/lang/String;
...
.method public static ـ(Landroid/hardware/Camera$Parameters;)V
    .locals 2
    .annotation build Landroid/annotation/TargetApi;
        value = 0xf
    .end annotation
...
.method public static ٴ(Landroid/hardware/Camera$Parameters;D)V
    .locals 2
    ...
    invoke-static {p0, p1, p2}, Lh22;->ʿ(Landroid/hardware/Camera$Parameters;D)Ljava/lang/Integer;
...
.method private static ᐧ(Ljava/lang/Iterable;)Ljava/lang/String;
    .locals 3
    .annotation build Landroid/annotation/TargetApi;
        value = 0xf
    .end annotation
...
.method private static ᴵ(Ljava/util/Collection;)Ljava/lang/String;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
