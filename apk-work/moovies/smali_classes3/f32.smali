...
# static fields
.field protected static final ᵔ:I = 0x7

.field private static final ᵢ:Ljava/lang/String; = "DataAsyncHttpRH"
...
.method ⁱ(Ld82;)[B
    ...
    invoke-direct {p1, v3}, Luw2;-><init>(I)V
    :try_end_0
    ...
    invoke-virtual {p1, v3, v5, v4}, Luw2;->ʽ([BII)V

    invoke-static {v3, v5, v4}, Lf32;->ˉˉ([BII)[B

    move-result-object v4

    invoke-virtual {p0, v4}, Lf32;->ˋˋ([B)V
...
.method protected ﹳ(Landroid/os/Message;)V
    ...
    invoke-super {p0, p1}, Lx22;->ﹳ(Landroid/os/Message;)V
    ...
    invoke-virtual {p0, p1}, Lf32;->ˈˈ([B)V
    :try_end_0
    ...
    invoke-interface {v1, v0, v2, p1}, Ln32;->ˎ(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
