...
.method public static final ʻ(Lu74;)Ljava/util/Map;
    .locals 6
    .param p0    # Lu74;
    ...
    :cond_1
    check-cast v3, Lij4$ˆ;

    iget v5, v3, Lij4$ˆ;->ʽʽ:I

    add-int/2addr v5, v4

    iput v5, v3, Lij4$ˆ;->ʽʽ:I
    ...
    invoke-static {v1}, Lsj4;->ˑ(Ljava/lang/Object;)Ljava/util/Map$Entry;
    ...
    check-cast v1, Lij4$ˆ;

    iget v1, v1, Lij4$ˆ;->ʽʽ:I
    ...
    :cond_3
    invoke-static {v0}, Lsj4;->ˎ(Ljava/lang/Object;)Ljava/util/Map;
...
.method private static final ʼ(Ljava/util/Map;Llg4;)Ljava/util/Map;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    :cond_0
    invoke-static {p0}, Lsj4;->ˎ(Ljava/lang/Object;)Ljava/util/Map;
